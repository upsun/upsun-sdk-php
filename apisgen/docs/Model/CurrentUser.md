...
**ssh_keys** | [**\OpenAPI\Client\Model\SSHKey[]**](SSHKey.md) | The list of user&#39;s public SSH keys. | [optional]
**has_key** | **bool** | The indicator whether the user has a public ssh key on file or not. | [optional]
**projects** | [**\OpenAPI\Client\Model\CurrentUserProjectsInner[]**](CurrentUserProjectsInner.md) |  | [optional]
...
**current_trial** | [**\OpenAPI\Client\Model\CurrentUserCurrentTrialInner[]**](CurrentUserCurrentTrialInner.md) |  | [optional]
