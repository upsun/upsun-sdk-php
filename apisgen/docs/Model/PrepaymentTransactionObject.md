...
**amount** | [**\OpenAPI\Client\Model\PrepaymentObjectPrepaymentBalance**](PrepaymentObjectPrepaymentBalance.md) |  | [optional]
**created** | **string** | Time the transaction was created. | [optional]
**updated** | **string** | Time the transaction was last updated. | [optional]
**expire_date** | **string** | The expiration date of the transaction (deposits only). | [optional]
