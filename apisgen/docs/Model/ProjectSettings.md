...
**data_retention** | [**array<string,\OpenAPI\Client\Model\DataRetentionConfigurationValue>**](DataRetentionConfigurationValue.md) |  |
**enable_codesource_integration_push** | **bool** |  |
**enforce_mfa** | **bool** |  |
**systemd** | **bool** |  |
**router_gen2** | **bool** |  |
**build_resources** | [**\OpenAPI\Client\Model\BuildResources1**](BuildResources1.md) |  |
...
**continuous_profiling** | [**\OpenAPI\Client\Model\TheContinuousProfilingConfiguration**](TheContinuousProfilingConfiguration.md) |  |
