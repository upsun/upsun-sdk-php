...
**commitment** | [**\OpenAPI\Client\Model\DiscountCommitment**](DiscountCommitment.md) |  | [optional]
**total_months** | **int** | The contract length in months (if applicable). | [optional]
**discount** | [**\OpenAPI\Client\Model\DiscountDiscount**](DiscountDiscount.md) |  | [optional]
