...
```php
createUsageAlert($subscription_id, $create_usage_alert_request): \OpenAPI\Client\Model\Alert
```
...
$create_usage_alert_request = new \OpenAPI\Client\Model\CreateUsageAlertRequest(); // \OpenAPI\Client\Model\CreateUsageAlertRequest
...
```php
getUsageAlerts($subscription_id): \OpenAPI\Client\Model\GetUsageAlerts200Response
```
...
[**\OpenAPI\Client\Model\GetUsageAlerts200Response**](../Model/GetUsageAlerts200Response.md)
...
```php
updateUsageAlert($subscription_id, $usage_id, $update_usage_alert_request): \OpenAPI\Client\Model\Alert
```
...
$subscription_id = 'subscription_id_example'; // string | The ID of the subscription
$usage_id = 'usage_id_example'; // string | The usage id of the alert.
$update_usage_alert_request = new \OpenAPI\Client\Model\UpdateUsageAlertRequest(); // \OpenAPI\Client\Model\UpdateUsageAlertRequest
