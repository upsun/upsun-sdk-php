...
| [**createOrgMember()**](OrganizationsApi.md#createOrgMember) | **POST** /organizations/{organization_id}/members | Create organization member |
| [**deleteOrg()**](OrganizationsApi.md#deleteOrg) | **DELETE** /organizations/{organization_id} | Delete organization |
| [**deleteOrgMember()**](OrganizationsApi.md#deleteOrgMember) | **DELETE** /organizations/{organization_id}/members/{user_id} | Delete organization member |
| [**getOrg()**](OrganizationsApi.md#getOrg) | **GET** /organizations/{organization_id} | Get organization |
| [**getOrgMember()**](OrganizationsApi.md#getOrgMember) | **GET** /organizations/{organization_id}/members/{user_id} | Get organization member |
| [**listOrgMembers()**](OrganizationsApi.md#listOrgMembers) | **GET** /organizations/{organization_id}/members | List organization members |
...
| [**updateOrgMember()**](OrganizationsApi.md#updateOrgMember) | **PATCH** /organizations/{organization_id}/members/{user_id} | Update organization member |
...
```php
createOrgMember($organization_id, $create_org_member_request): \OpenAPI\Client\Model\OrganizationMember
```
...
$create_org_member_request = new \OpenAPI\Client\Model\CreateOrgMemberRequest(); // \OpenAPI\Client\Model\CreateOrgMemberRequest

try {
    $result = $apiInstance->createOrgMember($organization_id, $create_org_member_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationsApi->createOrgMember: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\OrganizationMember**](../Model/OrganizationMember.md)
...
try {
    ...
    echo 'Exception when calling OrganizationsApi->deleteOrgMember: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getOrgMember($organization_id, $user_id): \OpenAPI\Client\Model\OrganizationMember
```
...
try {
    ...
    echo 'Exception when calling OrganizationsApi->getOrgMember: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listOrgMembers($organization_id, $filter_permissions, $page_size, $page_before, $page_after, $sort): \OpenAPI\Client\Model\ListOrgMembers200Response
```
...
$organization_id = 'organization_id_example'; // string | The ID of the organization.<br> Prefix with name= to retrieve the organization by name instead.
$filter_permissions = new \OpenAPI\Client\Model\\OpenAPI\Client\Model\ArrayFilter(); // \OpenAPI\Client\Model\ArrayFilter | Allows filtering by `permissions` using one or more operators.
...
try {
    ...
    echo 'Exception when calling OrganizationsApi->listOrgMembers: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ListOrgMembers200Response**](../Model/ListOrgMembers200Response.md)
...
```php
updateOrgMember($organization_id, $user_id, $update_org_member_request): \OpenAPI\Client\Model\OrganizationMember
```
...
$organization_id = 'organization_id_example'; // string | The ID of the organization.
$user_id = d81c8ee2-44b3-429f-b944-a33ad7437690; // string | The ID of the user.
$update_org_member_request = new \OpenAPI\Client\Model\UpdateOrgMemberRequest(); // \OpenAPI\Client\Model\UpdateOrgMemberRequest

try {
    $result = $apiInstance->updateOrgMember($organization_id, $user_id, $update_org_member_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling OrganizationsApi->updateOrgMember: ', $e->getMessage(), PHP_EOL;
}
```
