...
```php
createProjectsEnvironmentsVariables($project_id, $environment_id, $environment_variable_create_input): \OpenAPI\Client\Model\AcceptedResponse
```
...
$environment_variable_create_input = new \OpenAPI\Client\Model\EnvironmentVariableCreateInput(); // \OpenAPI\Client\Model\EnvironmentVariableCreateInput | 
...
```php
deleteProjectsEnvironmentsVariables($project_id, $environment_id, $variable_id): \OpenAPI\Client\Model\AcceptedResponse
```
...
```php
getProjectsEnvironmentsVariables($project_id, $environment_id, $variable_id): \OpenAPI\Client\Model\EnvironmentVariable
```
...
```php
listProjectsEnvironmentsVariables($project_id, $environment_id): \OpenAPI\Client\Model\EnvironmentVariable[]
```
...
```php
updateProjectsEnvironmentsVariables($project_id, $environment_id, $variable_id, $environment_variable_patch): \OpenAPI\Client\Model\AcceptedResponse
```
...
$environment_id = 'environment_id_example'; // string
$variable_id = 'variable_id_example'; // string
$environment_variable_patch = new \OpenAPI\Client\Model\EnvironmentVariablePatch(); // \OpenAPI\Client\Model\EnvironmentVariablePatch | 
