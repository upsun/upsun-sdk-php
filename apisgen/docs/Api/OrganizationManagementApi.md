...
| [**getOrgAddons()**](OrganizationManagementApi.md#getOrgAddons) | **GET** /organizations/{organization_id}/addons | Get add-ons |
...
try {
    ...
    echo 'Exception when calling OrganizationManagementApi->getOrgAddons: ', $e->getMessage(), PHP_EOL;
}
```
