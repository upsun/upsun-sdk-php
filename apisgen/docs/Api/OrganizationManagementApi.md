# OpenAPI\Client\OrganizationManagementApi
...
```php
estimateOrg($organization_id): \OpenAPI\Client\Model\OrganizationEstimationObject
```
...
$apiInstance = new OpenAPI\Client\Api\OrganizationManagementApi(
...
[**\OpenAPI\Client\Model\OrganizationEstimationObject**](../Model/OrganizationEstimationObject.md)
...
```php
getOrgBillingAlertConfig($organization_id): \OpenAPI\Client\Model\OrganizationAlertConfig
```
...
[**\OpenAPI\Client\Model\OrganizationAlertConfig**](../Model/OrganizationAlertConfig.md)
...
```php
getOrgPrepaymentInfo($organization_id): \OpenAPI\Client\Model\GetOrgPrepaymentInfo200Response
```
...
[**\OpenAPI\Client\Model\GetOrgPrepaymentInfo200Response**](../Model/GetOrgPrepaymentInfo200Response.md)
...
```php
listOrgPrepaymentTransactions($organization_id): \OpenAPI\Client\Model\ListOrgPrepaymentTransactions200Response
```
...
[**\OpenAPI\Client\Model\ListOrgPrepaymentTransactions200Response**](../Model/ListOrgPrepaymentTransactions200Response.md)
...
```php
updateOrgBillingAlertConfig($organization_id, $update_org_billing_alert_config_request): \OpenAPI\Client\Model\OrganizationAlertConfig
```
...
$organization_id = 'organization_id_example'; // string | The ID of the organization.<br> Prefix with name= to retrieve the organization by name instead.
$update_org_billing_alert_config_request = new \OpenAPI\Client\Model\UpdateOrgBillingAlertConfigRequest(); // \OpenAPI\Client\Model\UpdateOrgBillingAlertConfigRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **organization_id** | **string**| The ID of the organization.&lt;br&gt; Prefix with name&#x3D; to retrieve the organization by name instead. | |
| **update_org_billing_alert_config_request** | [**\OpenAPI\Client\Model\UpdateOrgBillingAlertConfigRequest**](../Model/UpdateOrgBillingAlertConfigRequest.md)|  | [optional] |
