...
```php
createProjectsEnvironmentsRoutes($project_id, $environment_id, $route_create_input): \OpenAPI\Client\Model\AcceptedResponse
```
...
$route_create_input = new \OpenAPI\Client\Model\RouteCreateInput(); // \OpenAPI\Client\Model\RouteCreateInput | 
...
```php
deleteProjectsEnvironmentsRoutes($project_id, $environment_id, $route_id): \OpenAPI\Client\Model\AcceptedResponse
```
...
```php
getProjectsEnvironmentsRoutes($project_id, $environment_id, $route_id): \OpenAPI\Client\Model\Route
```
...
```php
listProjectsEnvironmentsRoutes($project_id, $environment_id): \OpenAPI\Client\Model\Route[]
```
...
```php
updateProjectsEnvironmentsRoutes($project_id, $environment_id, $route_id, $route_patch): \OpenAPI\Client\Model\AcceptedResponse
```
...
$environment_id = 'environment_id_example'; // string
$route_id = 'route_id_example'; // string
$route_patch = new \OpenAPI\Client\Model\RoutePatch(); // \OpenAPI\Client\Model\RoutePatch | 
