...
```php
createProjectsCertificates($project_id, $certificate_create_input): \OpenAPI\Client\Model\AcceptedResponse
```
...
$certificate_create_input = new \OpenAPI\Client\Model\CertificateCreateInput(); // \OpenAPI\Client\Model\CertificateCreateInput | 
...
```php
deleteProjectsCertificates($project_id, $certificate_id): \OpenAPI\Client\Model\AcceptedResponse
```
...
```php
getProjectsCertificates($project_id, $certificate_id): \OpenAPI\Client\Model\Certificate
```
...
```php
listProjectsCertificates($project_id): \OpenAPI\Client\Model\Certificate[]
```
...
```php
updateProjectsCertificates($project_id, $certificate_id, $certificate_patch): \OpenAPI\Client\Model\AcceptedResponse
```
...
$project_id = 'project_id_example'; // string
$certificate_id = 'certificate_id_example'; // string
$certificate_patch = new \OpenAPI\Client\Model\CertificatePatch(); // \OpenAPI\Client\Model\CertificatePatch | 
