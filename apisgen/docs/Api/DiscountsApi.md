...
```php
getDiscount($id): \OpenAPI\Client\Model\Discount
```
...
```php
getTypeAllowance(): \OpenAPI\Client\Model\GetTypeAllowance200Response
```
...
[**\OpenAPI\Client\Model\GetTypeAllowance200Response**](../Model/GetTypeAllowance200Response.md)
...
```php
listOrgDiscounts($organization_id): \OpenAPI\Client\Model\ListOrgDiscounts200Response
```
...
[**\OpenAPI\Client\Model\ListOrgDiscounts200Response**](../Model/ListOrgDiscounts200Response.md)
