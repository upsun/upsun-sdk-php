...
```php
getProjectsEnvironmentsDeployments($project_id, $environment_id, $deployment_id): \OpenAPI\Client\Model\Deployment
```
...
[**\OpenAPI\Client\Model\Deployment**](../Model/Deployment.md)
...
```php
listProjectsEnvironmentsDeployments($project_id, $environment_id): \OpenAPI\Client\Model\Deployment[]
```
