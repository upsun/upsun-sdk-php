...
```php
getOrgProject($organization_id, $project_id): \OpenAPI\Client\Model\OrganizationProject
```
...
[**\OpenAPI\Client\Model\OrganizationProject**](../Model/OrganizationProject.md)
...
```php
listOrgProjects($organization_id, $filter_id, $filter_title, $filter_status, $filter_updated_at, $filter_created_at, $page_size, $page_before, $page_after, $sort): \OpenAPI\Client\Model\ListOrgProjects200Response
```
...
$filter_title = new \OpenAPI\Client\Model\\OpenAPI\Client\Model\StringFilter(); // \OpenAPI\Client\Model\StringFilter | Allows filtering by `title` using one or more operators.
$filter_status = new \OpenAPI\Client\Model\\OpenAPI\Client\Model\StringFilter(); // \OpenAPI\Client\Model\StringFilter | Allows filtering by `status` using one or more operators.
...
$filter_created_at = new \OpenAPI\Client\Model\\OpenAPI\Client\Model\DateTimeFilter(); // \OpenAPI\Client\Model\DateTimeFilter | Allows filtering by `created_at` using one or more operators.
...
[**\OpenAPI\Client\Model\ListOrgProjects200Response**](../Model/ListOrgProjects200Response.md)
