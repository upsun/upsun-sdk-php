# OpenAPI\Client\EnvironmentActivityApi
...
```php
actionProjectsEnvironmentsActivitiesCancel($project_id, $environment_id, $activity_id): \OpenAPI\Client\Model\AcceptedResponse
```
...
$apiInstance = new OpenAPI\Client\Api\EnvironmentActivityApi(
...
```php
getProjectsEnvironmentsActivities($project_id, $environment_id, $activity_id): \OpenAPI\Client\Model\Activity
```
...
```php
listProjectsEnvironmentsActivities($project_id, $environment_id): \OpenAPI\Client\Model\Activity[]
```
