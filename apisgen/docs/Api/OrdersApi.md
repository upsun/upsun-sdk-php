...
```php
createAuthorizationCredentials($organization_id, $order_id): \OpenAPI\Client\Model\CreateAuthorizationCredentials200Response
```
...
[**\OpenAPI\Client\Model\CreateAuthorizationCredentials200Response**](../Model/CreateAuthorizationCredentials200Response.md)
