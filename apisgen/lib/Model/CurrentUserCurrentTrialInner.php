...
/**
 * CurrentUserCurrentTrialInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CurrentUserCurrentTrialInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrentUser_current_trial_inner';
    ...
    */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The ISO timestamp of the trial creation date time.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The human readable trial description
     *
     * @return self
     */
     ...
     *
     * @param string|null $spend_remaining Total spend amount of the voucher minus existing project costs for the existing billing cycle.
     *
     * @return self
     */
     ...
     * Sets expiration
     *
     * @param \DateTime|null $expiration Date the trial expires.
     *
     * @return self
     */
