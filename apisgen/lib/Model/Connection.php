...
class Connection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets provider
     *
     * @param string|null $provider The name of the federation provider.
     *
     * @return self
     */
     ...
     * Sets provider_type
     *
     * @param string|null $provider_type The type of the federation provider.
     *
     * @return self
     */
     ...
     * Sets is_mandatory
     *
     * @param bool|null $is_mandatory Whether the federated login connection is mandatory.
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject The identity on the federation provider.
     *
     * @return self
     */
     ...
     * Sets email_address
     *
     * @param string|null $email_address The email address presented on the federated login connection.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time when the connection was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The date and time when the connection was last updated.
     *
     * @return self
     */
