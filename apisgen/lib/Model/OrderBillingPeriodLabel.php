...
/**
 * OrderBillingPeriodLabel Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderBillingPeriodLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Order_billing_period_label';
    ...
    */
     ...
     * Sets formatted
     *
     * @param string|null $formatted The renderable label for the billing cycle.
     *
     * @return self
     */
     ...
     * Sets month
     *
     * @param string|null $month The month of the billing cycle.
     *
     * @return self
     */
     ...
     * Sets year
     *
     * @param string|null $year The year of the billing cycle.
     *
     * @return self
     */
     ...
     * Sets next_month
     *
     * @param string|null $next_month The name of the next month following this billing cycle.
     *
     * @return self
     */
