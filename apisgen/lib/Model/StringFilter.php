...
/**
 * StringFilter Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StringFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringFilter';
    ...
    */
     ...
     * Sets ne
     *
     * @param string|null $ne Not equal
     *
     * @return self
     */
     ...
     * Sets in
     *
     * @param string|null $in In (comma-separated list)
     *
     * @return self
     */
     ...
     * Sets nin
     *
     * @param string|null $nin Not in (comma-separated list)
     *
     * @return self
     */
     ...
     * Sets between
     *
     * @param string|null $between Between (comma-separated list)
     *
     * @return self
     */
     ...
     * Sets starts
     *
     * @param string|null $starts Starts with
     *
     * @return self
     */
     ...
     * Sets ends
     *
     * @param string|null $ends Ends with
     *
     * @return self
     */
