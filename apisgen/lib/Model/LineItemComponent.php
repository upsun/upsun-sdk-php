...
/**
 * LineItemComponent Class Doc Comment
 *
 * @category Class
 ...
 */
class LineItemComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineItemComponent';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The price as a decimal.
     *
     * @return self
     */
     ...
     *
     * @param string|null $amount_formatted The price formatted with currency.
     *
     * @return self
     */
     ...
     * Sets display_title
     *
     * @param string|null $display_title The display title for the component.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency code for the component.
     *
     * @return self
     */
