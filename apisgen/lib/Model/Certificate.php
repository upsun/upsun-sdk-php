...
class Certificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'domains' => 'string[]',
        'auth_type' => 'string[]',
        'issuer' => '\OpenAPI\Client\Model\TheIssuerOfTheCertificateInner[]',
        'expires_at' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets issuer
     *
     * @return \OpenAPI\Client\Model\TheIssuerOfTheCertificateInner[]
     */
     ...
     * Sets issuer
     *
     * @param \OpenAPI\Client\Model\TheIssuerOfTheCertificateInner[] $issuer issuer
     *
     * @return self
     */
