...
class OrganizationMember implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        '_links' => '\OpenAPI\Client\Model\OrganizationMemberLinks'
    ];
    ...
    */
     ...
     * Sets permissions
     *
     * @param string[]|null $permissions The organization member permissions.
     *
     * @return self
     */
     ...
     * Sets level
     *
     * @param string|null $level Access level of the member.
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param bool|null $owner Whether the member is the organization owner.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time when the member was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The date and time when the member was last updated.
     *
     * @return self
     */
     ...
     * Gets _links
     *
     * @return \OpenAPI\Client\Model\OrganizationMemberLinks|null
     */
     ...
     * Sets _links
     *
     * @param \OpenAPI\Client\Model\OrganizationMemberLinks|null $_links _links
     *
     * @return self
     */
