...
/**
 * GrantProjectUserAccessRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GrantProjectUserAccessRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'grant_project_user_access_request_inner';
    ...
    */
     ...
     * Sets permissions
     *
     * @param string[] $permissions An array of project permissions.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $auto_add_member If the specified user is not a member of the project's organization, add it automatically.
     *
     * @return self
     */
