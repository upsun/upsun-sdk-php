...
/**
 * UpdateTicketRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateTicketRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_ticket_request';
    ...
    */
     ...
     *
     * @param bool|null $collaborators_replace Whether or not should replace ticket collaborators with the provided values. If false, the collaborators will be appended.
     *
     * @return self
     */
