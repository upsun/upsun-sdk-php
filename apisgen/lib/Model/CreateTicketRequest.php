...
class CreateTicketRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_ticket_request';
    ...
    protected static $openAPITypes = [
        ...
        'followup_tid' => 'string',
        'category' => 'string',
        'attachments' => '\OpenAPI\Client\Model\CreateTicketRequestAttachmentsInner[]',
    ...
    */
     ...
     * Sets subject
     *
     * @param string $subject A title of the ticket.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The description body of the support ticket.
     *
     * @return self
     */
     ...
     * Sets requester_id
     *
     * @param string|null $requester_id UUID of the ticket requester. Converted from the ZID value.
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_id see create()
     *
     * @return self
     */
     ...
     *
     * @param string|null $organization_id see create()
     *
     * @return self
     */
     ...
     * Sets affected_url
     *
     * @param string|null $affected_url see create().
     *
     * @return self
     */
     ...
     * Sets followup_tid
     *
     * @param string|null $followup_tid The unique ID of the ticket which this ticket is a follow-up to.
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category The category of the support ticket.
     *
     * @return self
     */
     ...
     * Gets attachments
     *
     * @return \OpenAPI\Client\Model\CreateTicketRequestAttachmentsInner[]|null
     */
     ...
     * Sets attachments
     *
     * @param \OpenAPI\Client\Model\CreateTicketRequestAttachmentsInner[]|null $attachments A list of attachments for the ticket.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $collaborator_ids A list of collaborators uuids for the ticket.
     *
     * @return self
     */
