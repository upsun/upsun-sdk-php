...
/**
 * ProfileCurrentTrialProjectsTotal Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProfileCurrentTrialProjectsTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_current_trial_projects_total';
    ...
    */
     ...
     * Sets amount
     *
     * @param int|null $amount Trial project cost
     *
     * @return self
     */
     ...
     * Sets formatted
     *
     * @param string|null $formatted Trial project cost formatted with currency sign
     *
     * @return self
     */
