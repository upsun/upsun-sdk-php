 ...
 */
class TeamCounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Team_counts';
    ...
    */
     ...
     * Sets member_count
     *
     * @param int|null $member_count Total count of members of the team.
     *
     * @return self
     */
     ...
     * Sets project_count
     *
     * @param int|null $project_count Total count of projects that the team has access to.
     *
     * @return self
     */
