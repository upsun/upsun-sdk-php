...
/**
 * TicketJiraInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TicketJiraInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ticket_jira_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The id of the query.
     *
     * @return self
     */
     ...
     * Sets issue_id
     *
     * @param int|null $issue_id The issue id number.
     *
     * @return self
     */
     ...
     * Sets issue_key
     *
     * @param string|null $issue_key The issue key.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param float|null $created_at The created at timestamp.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param float|null $updated_at The updated at timestamp.
     *
     * @return self
     */
