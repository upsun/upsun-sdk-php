...
/**
 * OrganizationEstimationObjectSubscriptionsListInner Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationEstimationObjectSubscriptionsListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationEstimationObject_subscriptions_list_inner';
    ...
    protected static $openAPITypes = [
        ...
        'total' => 'string',
        'usage' => '\OpenAPI\Client\Model\OrganizationEstimationObjectSubscriptionsListInnerUsage'
    ];
    ...
    */
     ...
     * Sets license_id
     *
     * @param string|null $license_id The id of the subscription.
     *
     * @return self
     */
     ...
     * Sets project_title
     *
     * @param string|null $project_title The name of the project.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param string|null $total The total price for the subscription.
     *
     * @return self
     */
     ...
     * Gets usage
     *
     * @return \OpenAPI\Client\Model\OrganizationEstimationObjectSubscriptionsListInnerUsage|null
     */
     ...
     * Sets usage
     *
     * @param \OpenAPI\Client\Model\OrganizationEstimationObjectSubscriptionsListInnerUsage|null $usage usage
     *
     * @return self
     */
