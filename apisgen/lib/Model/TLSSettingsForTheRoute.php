...
/**
 * TLSSettingsForTheRoute Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TLSSettingsForTheRoute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TLS_settings_for_the_route_';
    ...
    protected static $openAPITypes = [
        'strict_transport_security' => '\OpenAPI\Client\Model\StrictTransportSecurityOptions',
        'min_version' => 'string',
     ...
     * @return string[]
     */
    public function getMinVersionAllowableValues()
    {
        return [
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\StrictTransportSecurityOptions
     */
     ...
     *
     * @param \OpenAPI\Client\Model\StrictTransportSecurityOptions $strict_transport_security strict_transport_security
     *
     * @return self
     */
     ...
     * Sets min_version
     *
     * @param string $min_version min_version
     *
     * @return self
     */
     ...
     *
     * @param string $client_authentication client_authentication
     *
     * @return self
     */
     ...
     *
     * @param string[] $client_certificate_authorities client_certificate_authorities
     *
     * @return self
     */
