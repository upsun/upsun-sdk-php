 ...
 */
class InvoicePDF implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePDF';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url A link to the PDF invoice.
     *
     * @return self
     */
