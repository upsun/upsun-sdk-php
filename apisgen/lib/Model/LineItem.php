...
class LineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'components' => 'array<string,\OpenAPI\Client\Model\LineItemComponent>',
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of line item.
     *
     * @return self
     */
     ...
     * Sets license_id
     *
     * @param float|null $license_id The associated subscription identifier.
     *
     * @return self
     */
     ...
     * Sets project_id
     *
     * @param string|null $project_id The associated project identifier.
     *
     * @return self
     */
     ...
     * Sets product
     *
     * @param string|null $product Display name of the line item product.
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku The line item product SKU.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total Total price as a decimal.
     *
     * @return self
     */
     ...
     *
     * @param string|null $total_formatted Total price, formatted with currency.
     *
     * @return self
     */
     ...
     * Gets components
     *
     * @return array<string,\OpenAPI\Client\Model\LineItemComponent>|null
     */
     ...
     * Sets components
     *
     * @param array<string,\OpenAPI\Client\Model\LineItemComponent>|null $components The price components for the line item, keyed by type.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $exclude_from_invoice Line item should not be considered billable.
     *
     * @return self
     */
