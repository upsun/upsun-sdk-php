...
class Components implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('voucher_vat_baseprice', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param object|null $voucher_vat_baseprice stub
     *
     * @return self
     */
    public function setVoucherVatBaseprice($voucher_vat_baseprice)
    {
        ...
        $this->container['voucher_vat_baseprice'] = $voucher_vat_baseprice;
