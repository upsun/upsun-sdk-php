...
/**
 * OrganizationMFAEnforcement Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationMFAEnforcement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationMFAEnforcement';
    ...
    */
     ...
     * Sets enforce_mfa
     *
     * @param bool|null $enforce_mfa Whether the MFA enforcement is enabled.
     *
     * @return self
     */
