...
class Alert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The identification of the alert type.
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Whether the alert is currently active.
     *
     * @return self
     */
     ...
     * Sets alerts_sent
     *
     * @param int|null $alerts_sent The amount of alerts of this type that have been sent so far.
     *
     * @return self
     */
     ...
     * Sets last_alert_at
     *
     * @param \DateTime|null $last_alert_at The time the last alert has been sent.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The time the alert has last been updated.
     *
     * @return self
     */
