...
/**
 * TeamReference Class Doc Comment
 *
 * @category Class
 ...
 */
class TeamReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TeamReference';
    ...
    protected static $openAPITypes = [
        ...
        'counts' => '\OpenAPI\Client\Model\TeamCounts',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime'
    ];
     ...
     * @return string[]
     */
    public function getProjectPermissionsAllowableValues()
    {
        return [
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the team.
     *
     * @return self
     */
     ...
     *
     * @param string|null $organization_id The ID of the parent organization.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The human-readable label of the team.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $project_permissions Project permissions that are granted to the team.
     *
     * @return self
     */
     ...
     * Gets counts
     *
     * @return \OpenAPI\Client\Model\TeamCounts|null
     */
     ...
     * Sets counts
     *
     * @param \OpenAPI\Client\Model\TeamCounts|null $counts counts
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time when the team was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The date and time when the team was last updated.
     *
     * @return self
     */
