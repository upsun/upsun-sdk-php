...
/**
 * CreateOrgInviteRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrgInviteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_org_invite_request';
    ...
    */
     ...
     * Sets permissions
     *
     * @param string[] $permissions The permissions the invitee should be given on the organization.
     *
     * @return self
     */
