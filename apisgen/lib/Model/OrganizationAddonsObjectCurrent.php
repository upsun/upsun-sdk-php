...
class OrganizationAddonsObjectCurrent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $user_management The type of user management currently selected.
     *
     * @return self
     */
     ...
     * Sets support_level
     *
     * @param string|null $support_level The level of support currently selected.
     *
     * @return self
     */
