...
class UserReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets mfa_enabled
     *
     * @param bool|null $mfa_enabled Whether the user has enabled MFA. Note: the built-in MFA feature may not be necessary if the user is linked to a mandatory SSO provider that itself supports MFA (see \"sso_enabled\\\").
     *
     * @return self
     */
     ...
     * Sets sso_enabled
     *
     * @param bool|null $sso_enabled Whether the user is linked to a mandatory SSO provider.
     *
     * @return self
     */
