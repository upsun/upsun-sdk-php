...
/**
 * UsageGroupCurrentUsageProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class UsageGroupCurrentUsageProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageGroupCurrentUsageProperties';
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title The title of the usage group.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param bool|null $type The usage group type.
     *
     * @return self
     */
     ...
     * Sets current_usage
     *
     * @param float|null $current_usage The value of current usage for the group.
     *
     * @return self
     */
     ...
     *
     * @param string|null $current_usage_formatted The formatted value of current usage for the group.
     *
     * @return self
     */
     ...
     * Sets not_charged
     *
     * @param bool|null $not_charged Whether the group is not charged for the subscription.
     *
     * @return self
     */
     ...
     * Sets free_quantity
     *
     * @param float|null $free_quantity The amount of free usage for the group.
     *
     * @return self
     */
     ...
     *
     * @param string|null $free_quantity_formatted The formatted amount of free usage for the group.
     *
     * @return self
     */
     ...
     * Sets daily_average
     *
     * @param float|null $daily_average The daily average usage calculated for the group.
     *
     * @return self
     */
     ...
     *
     * @param string|null $daily_average_formatted The formatted daily average usage calculated for the group.
     *
     * @return self
     */
