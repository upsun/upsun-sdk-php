...
class SubscriptionAddonsObjectCurrent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,float>|null $continuous_profiling The current continuous profiling level of the license.
     *
     * @return self
     */
     ...
     *
     * @param array<string,float>|null $project_support_level The current project uptime level of the license.
     *
     * @return self
     */
