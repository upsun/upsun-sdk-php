...
class APIToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the token.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $mfa_on_creation Whether the user had multi-factor authentication (MFA) enabled when they created the token.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token The token in plain text (available only when created).
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time when the token was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The date and time when the token was last updated.
     *
     * @return self
     */
