...
/**
 * ListUserExtendedAccess200ResponseItemsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListUserExtendedAccess200ResponseItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'list_user_extended_access_200_response_items_inner';
    ...
    */
     ...
     * Sets resource_id
     *
     * @param string|null $resource_id The ID of the resource.
     *
     * @return self
     */
     ...
     * Sets resource_type
     *
     * @param string|null $resource_type The type of the resource access to which is granted.
     *
     * @return self
     */
     ...
     *
     * @param string|null $organization_id The ID of the organization owning the resource.
     *
     * @return self
     */
     ...
     * Sets permissions
     *
     * @param string[]|null $permissions List of project permissions.
     *
     * @return self
     */
     ...
     * Sets granted_at
     *
     * @param \DateTime|null $granted_at The date and time when the access was granted.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The date and time when the access was updated.
     *
     * @return self
     */
