...
class Region implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'private' => 'bool',
        'endpoint' => 'string',
        'provider' => '\OpenAPI\Client\Model\RegionProvider',
        'datacenter' => '\OpenAPI\Client\Model\RegionDatacenter',
        'environmental_impact' => '\OpenAPI\Client\Model\RegionEnvironmentalImpact'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the region.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The human-readable name of the region.
     *
     * @return self
     */
     ...
     * Sets zone
     *
     * @param string|null $zone Geographical zone of the region
     *
     * @return self
     */
     ...
     *
     * @param string|null $selection_label The label to display when choosing between regions for new projects.
     *
     * @return self
     */
     ...
     * Sets project_label
     *
     * @param string|null $project_label The label to display on existing projects.
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone Default timezone of the region
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param bool|null $available Indicator whether or not this region is selectable during the checkout. Not available regions will never show up during checkout.
     *
     * @return self
     */
     ...
     * Sets endpoint
     *
     * @param string|null $endpoint Link to the region API endpoint.
     *
     * @return self
     */
     ...
     * Gets provider
     *
     * @return \OpenAPI\Client\Model\RegionProvider|null
     */
     ...
     * Sets provider
     *
     * @param \OpenAPI\Client\Model\RegionProvider|null $provider provider
     *
     * @return self
     */
     ...
     * Gets datacenter
     *
     * @return \OpenAPI\Client\Model\RegionDatacenter|null
     */
     ...
     * Sets datacenter
     *
     * @param \OpenAPI\Client\Model\RegionDatacenter|null $datacenter datacenter
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\RegionEnvironmentalImpact|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RegionEnvironmentalImpact|null $environmental_impact environmental_impact
     *
     * @return self
     */
