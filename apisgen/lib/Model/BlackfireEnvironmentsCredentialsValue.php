...
/**
 * BlackfireEnvironmentsCredentialsValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BlackfireEnvironmentsCredentialsValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Blackfire_environments_credentials_value';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('server_token', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['server_token'] === null) {
            $invalidProperties[] = "'server_token' can't be null";
        }
     ...
     * Sets server_uuid
     *
     * @param string $server_uuid server_uuid
     *
     * @return self
     */
     ...
     * Sets server_token
     *
     * @param string $server_token server_token
     *
     * @return self
     */
    public function setServerToken($server_token)
    {
        ...
        $this->container['server_token'] = $server_token;
