...
/**
 * ProfileCurrentTrialSpendRemaining Class Doc Comment
 *
 * @category Class
 ...
 */
class ProfileCurrentTrialSpendRemaining implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_current_trial_spend_remaining';
    ...
    */
     ...
     * Sets formatted
     *
     * @param string|null $formatted The total amount formatted.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount The total amount.
     *
     * @return self
     */
     ...
     * Sets unlimited
     *
     * @param bool|null $unlimited Spend limit is ignored (in favor of resource limitations).
     *
     * @return self
     */
