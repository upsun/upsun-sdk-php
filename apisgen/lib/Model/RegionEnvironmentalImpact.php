...
/**
 * RegionEnvironmentalImpact Class Doc Comment
 *
 * @category Class
 ...
 */
class RegionEnvironmentalImpact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Region_environmental_impact';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('carbon_intensity', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $carbon_intensity carbon_intensity
     *
     * @return self
     */
    public function setCarbonIntensity($carbon_intensity)
    {
        ...
        $this->container['carbon_intensity'] = $carbon_intensity;
