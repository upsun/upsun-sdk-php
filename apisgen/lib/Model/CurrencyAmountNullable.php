...
/**
 * CurrencyAmountNullable Class Doc Comment
 *
 * @category Class
 ...
 */
class CurrencyAmountNullable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyAmountNullable';
    ...
    */
     ...
     * Sets formatted
     *
     * @param string|null $formatted Formatted currency value.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Plain amount.
     *
     * @return self
     */
