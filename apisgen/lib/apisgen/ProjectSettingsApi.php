...
class ProjectSettingsApi
{
     ...
     */
    public function getProjectsSettingsWithHttpInfo($project_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsSettingsAsync($project_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsSettingsAsyncWithHttpInfo($project_id)
    {
     ...
     */
    public function updateProjectsSettingsWithHttpInfo($project_id, $project_settings_patch)
    {
     ...
     * @return Promise
     */
    public function updateProjectsSettingsAsync($project_id, $project_settings_patch)
    {
     ...
     * @return Promise
     */
    public function updateProjectsSettingsAsyncWithHttpInfo($project_id, $project_settings_patch)
    {
     ...
     * @return RequestInterface
     */
    public function updateProjectsSettingsRequest($project_id, $project_settings_patch)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
