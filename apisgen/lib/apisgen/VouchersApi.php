...
class VouchersApi
{
     ...
     */
    public function applyOrgVoucherWithHttpInfo($organization_id, $apply_org_voucher_request)
    {
     ...
     * @return Promise
     */
    public function applyOrgVoucherAsync($organization_id, $apply_org_voucher_request)
    {
     ...
     * @return Promise
     */
    public function applyOrgVoucherAsyncWithHttpInfo($organization_id, $apply_org_voucher_request)
    {
        $returnType = '';
        $request = $this->applyOrgVoucherRequest($organization_id, $apply_org_voucher_request);
     ...
     */
    public function applyOrgVoucherRequest($organization_id, $apply_org_voucher_request)
    {
     ...
     */
    public function listOrgVouchersWithHttpInfo($organization_id)
    {
     ...
     * @return Promise
     */
    public function listOrgVouchersAsync($organization_id)
    {
     ...
     * @return Promise
     */
    public function listOrgVouchersAsyncWithHttpInfo($organization_id)
    {
     ...
     * @return RequestInterface
     */
    public function listOrgVouchersRequest($organization_id)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
