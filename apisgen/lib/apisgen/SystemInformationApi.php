...
class SystemInformationApi
{
     ...
     */
    public function actionProjectsSystemRestartWithHttpInfo($project_id)
    {
     ...
     * @return Promise
     */
    public function actionProjectsSystemRestartAsync($project_id)
    {
     ...
     * @return Promise
     */
    public function actionProjectsSystemRestartAsyncWithHttpInfo($project_id)
    {
     ...
     */
    public function actionProjectsSystemRestartRequest($project_id)
    {
     ...
     */
    public function getProjectsSystemWithHttpInfo($project_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsSystemAsync($project_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsSystemAsyncWithHttpInfo($project_id)
    {
     ...
     * @return RequestInterface
     */
    public function getProjectsSystemRequest($project_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
