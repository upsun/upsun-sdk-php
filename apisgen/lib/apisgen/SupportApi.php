...
class SupportApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\CreateTicketRequest $create_ticket_request create_ticket_request (optional)
     *
     ...
     * Create a new support ticket
     *
     * @param  \OpenAPI\Client\Model\CreateTicketRequest $create_ticket_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \OpenAPI\Client\Model\UpdateTicketRequest $update_ticket_request update_ticket_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Ticket
     ...
     *
     * @param  string $ticket_id The ID of the ticket (required)
     * @param  \OpenAPI\Client\Model\UpdateTicketRequest $update_ticket_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Ticket, HTTP status code, HTTP response headers (array of strings)
