...
class ConnectionsApi
{
     ...
     */
    public function deleteLoginConnectionWithHttpInfo($provider, $user_id)
    {
     ...
     * @return Promise
     */
    public function deleteLoginConnectionAsync($provider, $user_id)
    {
     ...
     * @return Promise
     */
    public function deleteLoginConnectionAsyncWithHttpInfo($provider, $user_id)
    {
        $returnType = '';
        $request = $this->deleteLoginConnectionRequest($provider, $user_id);
     ...
     */
    public function deleteLoginConnectionRequest($provider, $user_id)
    {
     ...
     */
    public function getLoginConnectionWithHttpInfo($provider, $user_id)
    {
     ...
     * @return Promise
     */
    public function getLoginConnectionAsync($provider, $user_id)
    {
     ...
     * @return Promise
     */
    public function getLoginConnectionAsyncWithHttpInfo($provider, $user_id)
    {
     ...
     * @return RequestInterface
     */
    public function getLoginConnectionRequest($provider, $user_id)
    {
        // verify the required parameter 'provider' is set
        if ($provider === null || (is_array($provider) && count($provider) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return array of \OpenAPI\Client\Model\Connection[]|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listLoginConnectionsWithHttpInfo($user_id)
    {
     ...
     * @return Promise
     */
    public function listLoginConnectionsAsync($user_id)
    {
     ...
     * @return Promise
     */
    public function listLoginConnectionsAsyncWithHttpInfo($user_id)
    {
        $returnType = '\OpenAPI\Client\Model\Connection[]';
        $request = $this->listLoginConnectionsRequest($user_id);
     ...
     * @return RequestInterface
     */
    public function listLoginConnectionsRequest($user_id)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
