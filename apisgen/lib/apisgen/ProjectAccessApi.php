...
/**
 * ProjectAccessApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ProjectAccessApi
{
    ...
    /**
     * Operation createProjectsAccess
     *
     * Add a user to a project ACL
     *
     * @param  string $project_id project_id (required)
     * @param  \OpenAPI\Client\Model\ProjectAccessCreateInput $project_access_create_input  (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createProjectsAccess'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function createProjectsAccess($project_id, $project_access_create_input, string $contentType = self::contentTypes['createProjectsAccess'][0])
    {
        list($response) = $this->createProjectsAccessWithHttpInfo($project_id, $project_access_create_input, $contentType);
        return $response;
    }

    /**
     * Operation createProjectsAccessWithHttpInfo
     *
     * Add a user to a project ACL
     *
     ...
     * @deprecated
     */
    public function createProjectsAccessWithHttpInfo($project_id, $project_access_create_input, string $contentType = self::contentTypes['createProjectsAccess'][0])
    {
        $request = $this->createProjectsAccessRequest($project_id, $project_access_create_input, $contentType);
    ...
    /**
     * Operation createProjectsAccessAsync
     *
     * Add a user to a project ACL
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function createProjectsAccessAsync($project_id, $project_access_create_input, string $contentType = self::contentTypes['createProjectsAccess'][0])
    {
        return $this->createProjectsAccessAsyncWithHttpInfo($project_id, $project_access_create_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createProjectsAccessAsyncWithHttpInfo
     *
     * Add a user to a project ACL
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function createProjectsAccessAsyncWithHttpInfo($project_id, $project_access_create_input, string $contentType = self::contentTypes['createProjectsAccess'][0])
    {
    ...
    /**
     * Create request for operation 'createProjectsAccess'
     *
     * @param  string $project_id (required)
     * @param  \OpenAPI\Client\Model\ProjectAccessCreateInput $project_access_create_input  (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createProjectsAccess'] to see the possible values for this operation
     ...
     * @deprecated
     */
    public function createProjectsAccessRequest($project_id, $project_access_create_input, string $contentType = self::contentTypes['createProjectsAccess'][0])
    {

        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling createProjectsAccess'
            );
        }

        // verify the required parameter 'project_access_create_input' is set
        if ($project_access_create_input === null || (is_array($project_access_create_input) && count($project_access_create_input) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_access_create_input when calling createProjectsAccess'
            );
        }


        $resourcePath = '/projects/{projectId}/access';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($project_access_create_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($project_access_create_input));
            } else {
                $httpBody = $project_access_create_input;
            }
    ...
    /**
     * Operation deleteProjectsAccess
     *
     * Remove a user from a project
     *
     * @param  string $project_id project_id (required)
     * @param  string $project_access_id project_access_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteProjectsAccess'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AcceptedResponse
     * @deprecated
     */
    public function deleteProjectsAccess($project_id, $project_access_id, string $contentType = self::contentTypes['deleteProjectsAccess'][0])
    {
        list($response) = $this->deleteProjectsAccessWithHttpInfo($project_id, $project_access_id, $contentType);
        return $response;
    }

    /**
     * Operation deleteProjectsAccessWithHttpInfo
     *
     * Remove a user from a project
     *
     * @param  string $project_id (required)
     * @param  string $project_access_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteProjectsAccess'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @deprecated
     */
    public function deleteProjectsAccessWithHttpInfo($project_id, $project_access_id, string $contentType = self::contentTypes['deleteProjectsAccess'][0])
    {
        $request = $this->deleteProjectsAccessRequest($project_id, $project_access_id, $contentType);
    ...
    /**
     * Operation deleteProjectsAccessAsync
     *
     * Remove a user from a project
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function deleteProjectsAccessAsync($project_id, $project_access_id, string $contentType = self::contentTypes['deleteProjectsAccess'][0])
    {
        return $this->deleteProjectsAccessAsyncWithHttpInfo($project_id, $project_access_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteProjectsAccessAsyncWithHttpInfo
     *
     * Remove a user from a project
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function deleteProjectsAccessAsyncWithHttpInfo($project_id, $project_access_id, string $contentType = self::contentTypes['deleteProjectsAccess'][0])
    {
        $returnType = '\OpenAPI\Client\Model\AcceptedResponse';
        $request = $this->deleteProjectsAccessRequest($project_id, $project_access_id, $contentType);
    ...
    /**
     * Create request for operation 'deleteProjectsAccess'
     *
     * @param  string $project_id (required)
     * @param  string $project_access_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteProjectsAccess'] to see the possible values for this operation
     ...
     * @deprecated
     */
    public function deleteProjectsAccessRequest($project_id, $project_access_id, string $contentType = self::contentTypes['deleteProjectsAccess'][0])
    {

        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling deleteProjectsAccess'
            );
        }

        // verify the required parameter 'project_access_id' is set
        if ($project_access_id === null || (is_array($project_access_id) && count($project_access_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_access_id when calling deleteProjectsAccess'
            );
        }


        $resourcePath = '/projects/{projectId}/access/{projectAccessId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($project_access_id !== null) {
            $resourcePath = str_replace(
                '{' . 'projectAccessId' . '}',
                ObjectSerializer::toPathValue($project_access_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getProjectsAccess
     *
     * Get a single project ACL entry
     *
     * @param  string $project_id project_id (required)
     * @param  string $project_access_id project_access_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProjectsAccess'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ProjectAccess
     * @deprecated
     */
    public function getProjectsAccess($project_id, $project_access_id, string $contentType = self::contentTypes['getProjectsAccess'][0])
    {
        list($response) = $this->getProjectsAccessWithHttpInfo($project_id, $project_access_id, $contentType);
        return $response;
    }

    /**
     * Operation getProjectsAccessWithHttpInfo
     *
     * Get a single project ACL entry
     *
     * @param  string $project_id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ProjectAccess, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getProjectsAccessWithHttpInfo($project_id, $project_access_id, string $contentType = self::contentTypes['getProjectsAccess'][0])
    {
        $request = $this->getProjectsAccessRequest($project_id, $project_access_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                default:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ProjectAccess',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation getProjectsAccessAsync
     *
     * Get a single project ACL entry
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function getProjectsAccessAsync($project_id, $project_access_id, string $contentType = self::contentTypes['getProjectsAccess'][0])
    {
        return $this->getProjectsAccessAsyncWithHttpInfo($project_id, $project_access_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProjectsAccessAsyncWithHttpInfo
     *
     * Get a single project ACL entry
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function getProjectsAccessAsyncWithHttpInfo($project_id, $project_access_id, string $contentType = self::contentTypes['getProjectsAccess'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ProjectAccess';
        $request = $this->getProjectsAccessRequest($project_id, $project_access_id, $contentType);
    ...
    /**
     * Create request for operation 'getProjectsAccess'
     *
     * @param  string $project_id (required)
     * @param  string $project_access_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProjectsAccess'] to see the possible values for this operation
     ...
     * @deprecated
     */
    public function getProjectsAccessRequest($project_id, $project_access_id, string $contentType = self::contentTypes['getProjectsAccess'][0])
    {

        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling getProjectsAccess'
            );
        }
        ...
        if ($project_access_id === null || (is_array($project_access_id) && count($project_access_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_access_id when calling getProjectsAccess'
            );
        }
    ...
    public function listProjectUserAccessRequest($project_id, $page_size = null, $page_before = null, $page_after = null, $sort = null, string $contentType = self::contentTypes['listProjectUserAccess'][0])
    {
        ...
        if ($page_size !== null && $page_size > 200) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProjectAccessApi.listProjectUserAccess, must be smaller than or equal to 200.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ProjectAccessApi.listProjectUserAccess, must be bigger than or equal to 1.');
        }
    ...
    /**
     * Operation listProjectsAccess
     *
     * Get a project&#39;s access control list
     *
     * @param  string $project_id project_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listProjectsAccess'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ProjectAccess[]
     * @deprecated
     */
    public function listProjectsAccess($project_id, string $contentType = self::contentTypes['listProjectsAccess'][0])
    {
        list($response) = $this->listProjectsAccessWithHttpInfo($project_id, $contentType);
        return $response;
    }

    /**
     * Operation listProjectsAccessWithHttpInfo
     *
     * Get a project&#39;s access control list
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function listProjectsAccessWithHttpInfo($project_id, string $contentType = self::contentTypes['listProjectsAccess'][0])
    {
        $request = $this->listProjectsAccessRequest($project_id, $contentType);
    ...
    /**
     * Operation listProjectsAccessAsync
     *
     * Get a project&#39;s access control list
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function listProjectsAccessAsync($project_id, string $contentType = self::contentTypes['listProjectsAccess'][0])
    {
        return $this->listProjectsAccessAsyncWithHttpInfo($project_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listProjectsAccessAsyncWithHttpInfo
     *
     * Get a project&#39;s access control list
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function listProjectsAccessAsyncWithHttpInfo($project_id, string $contentType = self::contentTypes['listProjectsAccess'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ProjectAccess[]';
        $request = $this->listProjectsAccessRequest($project_id, $contentType);
    ...
    /**
     * Create request for operation 'listProjectsAccess'
     *
     * @param  string $project_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listProjectsAccess'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function listProjectsAccessRequest($project_id, string $contentType = self::contentTypes['listProjectsAccess'][0])
    {

        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling listProjectsAccess'
            );
        }
    ...
    /**
     * Operation updateProjectsAccess
     *
     * Update a project user&#39;s role
     *
     * @param  string $project_id project_id (required)
     * @param  string $project_access_id project_access_id (required)
     * @param  \OpenAPI\Client\Model\ProjectAccessPatch $project_access_patch  (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateProjectsAccess'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AcceptedResponse
     * @deprecated
     */
    public function updateProjectsAccess($project_id, $project_access_id, $project_access_patch, string $contentType = self::contentTypes['updateProjectsAccess'][0])
    {
        list($response) = $this->updateProjectsAccessWithHttpInfo($project_id, $project_access_id, $project_access_patch, $contentType);
        return $response;
    }

    /**
     * Operation updateProjectsAccessWithHttpInfo
     *
     * Update a project user&#39;s role
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function updateProjectsAccessWithHttpInfo($project_id, $project_access_id, $project_access_patch, string $contentType = self::contentTypes['updateProjectsAccess'][0])
    {
        $request = $this->updateProjectsAccessRequest($project_id, $project_access_id, $project_access_patch, $contentType);
    ...
    /**
     * Operation updateProjectsAccessAsync
     *
     * Update a project user&#39;s role
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function updateProjectsAccessAsync($project_id, $project_access_id, $project_access_patch, string $contentType = self::contentTypes['updateProjectsAccess'][0])
    {
        return $this->updateProjectsAccessAsyncWithHttpInfo($project_id, $project_access_id, $project_access_patch, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateProjectsAccessAsyncWithHttpInfo
     *
     * Update a project user&#39;s role
     *
     * @param  string $project_id (required)
     ...
     * @deprecated
     */
    public function updateProjectsAccessAsyncWithHttpInfo($project_id, $project_access_id, $project_access_patch, string $contentType = self::contentTypes['updateProjectsAccess'][0])
    {
        $returnType = '\OpenAPI\Client\Model\AcceptedResponse';
        $request = $this->updateProjectsAccessRequest($project_id, $project_access_id, $project_access_patch, $contentType);
    ...
    /**
     * Create request for operation 'updateProjectsAccess'
     *
     * @param  string $project_id (required)
     * @param  string $project_access_id (required)
     * @param  \OpenAPI\Client\Model\ProjectAccessPatch $project_access_patch  (required)
     ...
     * @deprecated
     */
    public function updateProjectsAccessRequest($project_id, $project_access_id, $project_access_patch, string $contentType = self::contentTypes['updateProjectsAccess'][0])
    {

        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling updateProjectsAccess'
            );
        }
        ...
        if ($project_access_id === null || (is_array($project_access_id) && count($project_access_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_access_id when calling updateProjectsAccess'
            );
        }

        // verify the required parameter 'project_access_patch' is set
        if ($project_access_patch === null || (is_array($project_access_patch) && count($project_access_patch) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_access_patch when calling updateProjectsAccess'
            );
        }
        ...
        // for model (json/xml)
        if (isset($project_access_patch)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($project_access_patch));
            } else {
                $httpBody = $project_access_patch;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
