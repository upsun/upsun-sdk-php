...
class DeploymentTargetApi
{
     ...
     */
    public function createProjectsDeploymentsWithHttpInfo($project_id, $deployment_target_create_input)
    {
     ...
     * @return Promise
     */
    public function createProjectsDeploymentsAsync($project_id, $deployment_target_create_input)
    {
     ...
     * @return Promise
     */
    public function createProjectsDeploymentsAsyncWithHttpInfo($project_id, $deployment_target_create_input)
    {
     ...
     */
    public function createProjectsDeploymentsRequest($project_id, $deployment_target_create_input)
    {
     ...
     * @return array of \OpenAPI\Client\Model\AcceptedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteProjectsDeploymentsWithHttpInfo($project_id, $deployment_target_configuration_id)
    {
     ...
     * @return Promise
     */
    public function deleteProjectsDeploymentsAsync($project_id, $deployment_target_configuration_id)
    {
     ...
     * @return Promise
     */
    public function deleteProjectsDeploymentsAsyncWithHttpInfo($project_id, $deployment_target_configuration_id)
    {
        $returnType = '\OpenAPI\Client\Model\AcceptedResponse';
        $request = $this->deleteProjectsDeploymentsRequest($project_id, $deployment_target_configuration_id);
     ...
     * @return RequestInterface
     */
    public function deleteProjectsDeploymentsRequest($project_id, $deployment_target_configuration_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getProjectsDeploymentsWithHttpInfo($project_id, $deployment_target_configuration_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsDeploymentsAsync($project_id, $deployment_target_configuration_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsDeploymentsAsyncWithHttpInfo($project_id, $deployment_target_configuration_id)
    {
     ...
     * @return RequestInterface
     */
    public function getProjectsDeploymentsRequest($project_id, $deployment_target_configuration_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return array of \OpenAPI\Client\Model\DeploymentTarget[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listProjectsDeploymentsWithHttpInfo($project_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsDeploymentsAsync($project_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsDeploymentsAsyncWithHttpInfo($project_id)
    {
        $returnType = '\OpenAPI\Client\Model\DeploymentTarget[]';
        $request = $this->listProjectsDeploymentsRequest($project_id);
     ...
     * @return array of \OpenAPI\Client\Model\AcceptedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProjectsDeploymentsWithHttpInfo($project_id, $deployment_target_configuration_id, $deployment_target_patch)
    {
     ...
     * @return Promise
     */
    public function updateProjectsDeploymentsAsync($project_id, $deployment_target_configuration_id, $deployment_target_patch)
    {
     ...
     * @return Promise
     */
    public function updateProjectsDeploymentsAsyncWithHttpInfo($project_id, $deployment_target_configuration_id, $deployment_target_patch)
    {
        $returnType = '\OpenAPI\Client\Model\AcceptedResponse';
        $request = $this->updateProjectsDeploymentsRequest($project_id, $deployment_target_configuration_id, $deployment_target_patch);
     ...
     * @return RequestInterface
     */
    public function updateProjectsDeploymentsRequest($project_id, $deployment_target_configuration_id, $deployment_target_patch)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
