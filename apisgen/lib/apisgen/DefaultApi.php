...
class DefaultApi
{
     ...
     *
     * @param  int $filter_ticket_id The ID of the ticket. (optional)
     * @param  \DateTime $filter_created ISO dateformat expected. The time when the support ticket was created. (optional)
     * @param  \DateTime $filter_updated ISO dateformat expected. The time when the support ticket was updated. (optional)
     * @param  string $filter_type The type of the support ticket. (optional)
     * @param  string $filter_priority The priority of the support ticket. (optional)
     * @param  string $filter_status The status of the support ticket. (optional)
     * @param  string $filter_requester_id UUID of the ticket requester. Converted from the ZID value. (optional)
     * @param  string $filter_submitter_id UUID of the ticket submitter. Converted from the ZID value. (optional)
     * @param  string $filter_assignee_id UUID of the ticket assignee. Converted from the ZID value. (optional)
     * @param  bool $filter_has_incidents Whether or not this ticket has incidents. (optional)
     * @param  \DateTime $filter_due ISO dateformat expected. A time that the ticket is due at. (optional)
     * @param  string $search Search string for the ticket subject and description. (optional)
     * @param  int $page Page to be displayed. Defaults to 1. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ListTickets200Response
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ListTickets200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function listTicketsWithHttpInfo($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null)
    {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ListTickets200Response',
                        $request,
                        $response,
                    );
            }
     ...
     * @return Promise
     */
    public function listTicketsAsync($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null)
    {
     ...
     */
    public function listTicketsRequest($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null)
    {
