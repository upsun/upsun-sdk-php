...
class DefaultApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listTickets'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ListTickets200Response
     */
    public function listTickets($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null, string $contentType = self::contentTypes['listTickets'][0])
    {
        list($response) = $this->listTicketsWithHttpInfo($filter_ticket_id, $filter_created, $filter_updated, $filter_type, $filter_priority, $filter_status, $filter_requester_id, $filter_submitter_id, $filter_assignee_id, $filter_has_incidents, $filter_due, $search, $page, $contentType);
        return $response;
    }
     ...
     */
    public function listTicketsWithHttpInfo($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null, string $contentType = self::contentTypes['listTickets'][0])
    {
        $request = $this->listTicketsRequest($filter_ticket_id, $filter_created, $filter_updated, $filter_type, $filter_priority, $filter_status, $filter_requester_id, $filter_submitter_id, $filter_assignee_id, $filter_has_incidents, $filter_due, $search, $page, $contentType);
     ...
     */
    public function listTicketsAsync($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null, string $contentType = self::contentTypes['listTickets'][0])
    {
        return $this->listTicketsAsyncWithHttpInfo($filter_ticket_id, $filter_created, $filter_updated, $filter_type, $filter_priority, $filter_status, $filter_requester_id, $filter_submitter_id, $filter_assignee_id, $filter_has_incidents, $filter_due, $search, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function listTicketsRequest($filter_ticket_id = null, $filter_created = null, $filter_updated = null, $filter_type = null, $filter_priority = null, $filter_status = null, $filter_requester_id = null, $filter_submitter_id = null, $filter_assignee_id = null, $filter_has_incidents = null, $filter_due = null, $search = null, $page = null, string $contentType = self::contentTypes['listTickets'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_ticket_id,
            'filter[ticket_id]', // param base name
            'integer', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_created,
            'filter[created]', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_updated,
            'filter[updated]', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_priority,
            'filter[priority]', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_requester_id,
            'filter[requester_id]', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_submitter_id,
            'filter[submitter_id]', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_assignee_id,
            'filter[assignee_id]', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_has_incidents,
            'filter[has_incidents]', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
