...
class ProjectInvitationsApi
{
     ...
     *
     * @param  string $project_id The ID of the project. (required)
     * @param  \OpenAPI\Client\Model\CreateProjectInviteRequest $create_project_invite_request create_project_invite_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $project_id The ID of the project. (required)
     * @param  \OpenAPI\Client\Model\CreateProjectInviteRequest $create_project_invite_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $project_id The ID of the project. (required)
     * @param  \OpenAPI\Client\Model\StringFilter $filter_state Allows filtering by &#x60;state&#x60; of the invtations: \&quot;pending\&quot; (default), \&quot;error\&quot;. (optional)
