...
class OrganizationsApi
{
    ...
    public function listOrgMembersRequest($organization_id, $filter_permissions = null, $page_size = null, $page_before = null, $page_after = null, $sort = null, string $contentType = self::contentTypes['listOrgMembers'][0])
    {
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling OrganizationsApi.listOrgMembers, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 1) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling OrganizationsApi.listOrgMembers, must be bigger than or equal to 1.');
        }
