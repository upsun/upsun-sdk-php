...
class DeploymentApi
{
     ...
     */
    public function getProjectsEnvironmentsDeploymentsWithHttpInfo($project_id, $environment_id, $deployment_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsEnvironmentsDeploymentsAsync($project_id, $environment_id, $deployment_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsEnvironmentsDeploymentsAsyncWithHttpInfo($project_id, $environment_id, $deployment_id)
    {
     ...
     */
    public function getProjectsEnvironmentsDeploymentsRequest($project_id, $environment_id, $deployment_id)
    {
     ...
     * @return array of \OpenAPI\Client\Model\Deployment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listProjectsEnvironmentsDeploymentsWithHttpInfo($project_id, $environment_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsEnvironmentsDeploymentsAsync($project_id, $environment_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsEnvironmentsDeploymentsAsyncWithHttpInfo($project_id, $environment_id)
    {
        $returnType = '\OpenAPI\Client\Model\Deployment[]';
        $request = $this->listProjectsEnvironmentsDeploymentsRequest($project_id, $environment_id);
     ...
     * @return RequestInterface
     */
    public function listProjectsEnvironmentsDeploymentsRequest($project_id, $environment_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
