...
class RuntimeOperationsApi
{
     ...
     */
    public function runOperationWithHttpInfo($project_id, $environment_id, $deployment_id, $environment_operation_input)
    {
     ...
     * @return Promise
     */
    public function runOperationAsync($project_id, $environment_id, $deployment_id, $environment_operation_input)
    {
     ...
     * @return Promise
     */
    public function runOperationAsyncWithHttpInfo($project_id, $environment_id, $deployment_id, $environment_operation_input)
    {
     ...
     */
    public function runOperationRequest($project_id, $environment_id, $deployment_id, $environment_operation_input)
    {
