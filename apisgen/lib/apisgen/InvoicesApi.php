...
class InvoicesApi
{
     ...
     */
    public function getOrgInvoiceWithHttpInfo($invoice_id, $organization_id)
    {
     ...
     * @return Promise
     */
    public function getOrgInvoiceAsync($invoice_id, $organization_id)
    {
     ...
     * @return Promise
     */
    public function getOrgInvoiceAsyncWithHttpInfo($invoice_id, $organization_id)
    {
     ...
     */
    public function getOrgInvoiceRequest($invoice_id, $organization_id)
    {
     ...
     *
     * @param  string $organization_id The ID of the organization.&lt;br&gt; Prefix with name&#x3D; to retrieve the organization by name instead. (required)
     * @param  string $filter_status The status of the invoice. (optional)
     * @param  string $filter_type The invoice type. Use invoice for standard invoices, credit_memo for refund/credit invoices. (optional)
     * @param  string $filter_order_id The order id of Invoice. (optional)
     ...
     */
    public function listOrgInvoicesWithHttpInfo($organization_id, $filter_status = null, $filter_type = null, $filter_order_id = null, $page = null)
    {
     ...
     * @return Promise
     */
    public function listOrgInvoicesAsync($organization_id, $filter_status = null, $filter_type = null, $filter_order_id = null, $page = null)
    {
     ...
     * @return Promise
     */
    public function listOrgInvoicesAsyncWithHttpInfo($organization_id, $filter_status = null, $filter_type = null, $filter_order_id = null, $page = null)
    {
     ...
     * @return RequestInterface
     */
    public function listOrgInvoicesRequest($organization_id, $filter_status = null, $filter_type = null, $filter_order_id = null, $page = null)
    {
        // verify the required parameter 'organization_id' is set
        if ($organization_id === null || (is_array($organization_id) && count($organization_id) === 0)) {
            throw new \InvalidArgumentException(
