        ...
        return [
            ...
            'container_profiles' => [
                'BALANCED' => [
                    ...
                    '6' => ['cpu' => 6.0, 'memory' => 6080, 'cpu_type' => 'shared'],
                    '8' => ['cpu' => 8.0, 'memory' => 7296, 'cpu_type' => 'shared'],
                    '4.gc' => ['cpu' => 4.0, 'memory' => 16384, 'cpu_type' => 'guaranteed'],
                    '8.gc' => ['cpu' => 8.0, 'memory' => 32768, 'cpu_type' => 'guaranteed'],
                    '16.gc' => ['cpu' => 16.0, 'memory' => 65536, 'cpu_type' => 'guaranteed'],
                    '48.gc' => ['cpu' => 48.0, 'memory' => 196608, 'cpu_type' => 'guaranteed'],
                ],
                'HIGHER_MEMORY' => [
                    ...
                    '2' => ['cpu' => 2.0, 'memory' => 6336, 'cpu_type' => 'shared'],
                    '4' => ['cpu' => 4.0, 'memory' => 10496, 'cpu_type' => 'shared'],
                    '6' => ['cpu' => 6.0, 'memory' => 14080, 'cpu_type' => 'shared'],
                    '8' => ['cpu' => 8.0, 'memory' => 17408, 'cpu_type' => 'shared'],
                ],
                'HIGH_CPU' => [
                    ...
                    '4' => ['cpu' => 4.0, 'memory' => 1216, 'cpu_type' => 'shared'],
                    '6' => ['cpu' => 6.0, 'memory' => 1728, 'cpu_type' => 'shared'],
                    '8' => ['cpu' => 8.0, 'memory' => 2240, 'cpu_type' => 'shared'],
                    '4.gc' => ['cpu' => 4.0, 'memory' => 8192, 'cpu_type' => 'guaranteed'],
                    '8.gc' => ['cpu' => 8.0, 'memory' => 16384, 'cpu_type' => 'guaranteed'],
                    '16.gc' => ['cpu' => 16.0, 'memory' => 32768, 'cpu_type' => 'guaranteed'],
                    '48.gc' => ['cpu' => 48.0, 'memory' => 98304, 'cpu_type' => 'guaranteed'],
                ],
                'HIGH_MEMORY' => [
                    ...
                    '2' => ['cpu' => 2.0, 'memory' => 4032, 'cpu_type' => 'shared'],
                    '4' => ['cpu' => 4.0, 'memory' => 6720, 'cpu_type' => 'shared'],
                    '6' => ['cpu' => 6.0, 'memory' => 9024, 'cpu_type' => 'shared'],
                    '8' => ['cpu' => 8.0, 'memory' => 11200, 'cpu_type' => 'shared'],
                    '4.gc' => ['cpu' => 4.0, 'memory' => 32768, 'cpu_type' => 'guaranteed'],
                    '8.gc' => ['cpu' => 8.0, 'memory' => 65536, 'cpu_type' => 'guaranteed'],
                    '16.gc' => ['cpu' => 16.0, 'memory' => 131072, 'cpu_type' => 'guaranteed'],
                    '48.gc' => ['cpu' => 48.0, 'memory' => 393216, 'cpu_type' => 'guaranteed'],
                ],
            ],
        ];
    }
