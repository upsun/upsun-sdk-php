...
class EnvironmentTaskTest extends BaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $activityTask = new class (
            $upsunClient,
            $projectActivityApi,
            $environmentActivityApi
        ) extends ActivityTask {
        };
        $upsunClient->activity = $activityTask;
        ...
        $backupTask = new class (
            $upsunClient,
            $environmentBackupApi
        ) extends BackupTask {
        };
        $upsunClient->backup = $backupTask;
        ...
        $variableTask = new class (
            $upsunClient,
            $projectVariablesApi,
            $environmentVariablesApi
        ) extends VariableTask {
        };
        $upsunClient->variables = $variableTask;
        ...
        $domainTask = new class (
            $upsunClient,
            $domainManagementApi
        ) extends DomainTask {
        };
        $upsunClient->domain = $domainTask;
        ...
        $sourceTask = new class (
            $upsunClient,
            $sourceOperationApi
        ) extends SourceOperationTask {
        };
        $upsunClient->sourceOperation = $sourceTask;
