...
* Full name: `\Upsun\Api\RuntimeOperationsApi`
...
```php
public runOperation(string $projectId, string $environmentId, string $deploymentId, \Upsun\Model\EnvironmentOperationInput $environmentOperationInput): \Upsun\Model\AcceptedResponse
```
...
| `$deploymentId`              | **string**                                 |             |
| `$environmentOperationInput` | **\Upsun\Model\EnvironmentOperationInput** | (required)  |
...
* https://docs.upsun.com/api/#tag/Runtime-Operations/operation/run-operation

***

### runOperationWithHttpInfo

Execute a runtime operation with HTTP Info

```php
private runOperationWithHttpInfo(string $projectId, string $environmentId, string $deploymentId, \Upsun\Model\EnvironmentOperationInput $environmentOperationInput): \Upsun\Model\AcceptedResponse
```
...
```php
private runOperationRequest(string $projectId, string $environmentId, string $deploymentId, \Upsun\Model\EnvironmentOperationInput $environmentOperationInput): \Psr\Http\Message\RequestInterface
```
