...
```php
public listUserExtendedAccess(string $userId, \Upsun\Model\StringFilter|null $filterResourceType = null, \Upsun\Model\StringFilter|null $filterOrganizationId = null, \Upsun\Model\StringFilter|null $filterPermissions = null): \Upsun\Model\ListUserExtendedAccess200Response
```
...
* https://docs.upsun.com/api/#tag/Grants/operation/list-user-extended-access

***

### listUserExtendedAccessWithHttpInfo

List extended access of a user with HTTP Info

```php
private listUserExtendedAccessWithHttpInfo(string $userId, \Upsun\Model\StringFilter|null $filterResourceType = null, \Upsun\Model\StringFilter|null $filterOrganizationId = null, \Upsun\Model\StringFilter|null $filterPermissions = null): \Upsun\Model\ListUserExtendedAccess200Response
```
...
```php
private listUserExtendedAccessRequest(string $userId, \Upsun\Model\StringFilter|null $filterResourceType = null, \Upsun\Model\StringFilter|null $filterOrganizationId = null, \Upsun\Model\StringFilter|null $filterPermissions = null): \Psr\Http\Message\RequestInterface
```
