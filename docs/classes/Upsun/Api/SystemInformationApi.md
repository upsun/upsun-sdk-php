...
* Full name: `\Upsun\Api\SystemInformationApi`
...
```php
public actionProjectsSystemRestart(string $projectId): \Upsun\Model\AcceptedResponse
```
...
* https://docs.upsun.com/api/#tag/System-Information/operation/action-projects-system-restart

***

### actionProjectsSystemRestartWithHttpInfo

Restart the Git server with HTTP Info

```php
private actionProjectsSystemRestartWithHttpInfo(string $projectId): \Upsun\Model\AcceptedResponse
```
...
### actionProjectsSystemRestartRequest

Create request for operation 'actionProjectsSystemRestart'

```php
private actionProjectsSystemRestartRequest(string $projectId): \Psr\Http\Message\RequestInterface
```
...
```php
public getProjectsSystem(string $projectId): \Upsun\Model\SystemInformation
```
...
* https://docs.upsun.com/api/#tag/System-Information/operation/get-projects-system

***

### getProjectsSystemWithHttpInfo

Get information about the Git server. with HTTP Info

```php
private getProjectsSystemWithHttpInfo(string $projectId): \Upsun\Model\SystemInformation
```
...
### getProjectsSystemRequest

Create request for operation 'getProjectsSystem'

```php
private getProjectsSystemRequest(string $projectId): \Psr\Http\Message\RequestInterface
```
