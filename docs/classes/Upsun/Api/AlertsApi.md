...
```php
public getUsageAlerts(string $subscriptionId): \Upsun\Model\GetUsageAlerts200Response
```
...
* https://docs.upsun.com/api/#tag/Alerts/operation/get-usage-alerts

***

### getUsageAlertsWithHttpInfo

Get usage alerts for a subscription with HTTP Info

```php
private getUsageAlertsWithHttpInfo(string $subscriptionId): \Upsun\Model\GetUsageAlerts200Response
```
...
### getUsageAlertsRequest

Create request for operation 'getUsageAlerts'

```php
private getUsageAlertsRequest(string $subscriptionId): \Psr\Http\Message\RequestInterface
```
...
```php
public updateUsageAlerts(string $subscriptionId, ?\Upsun\Model\UpdateUsageAlertsRequest $updateUsageAlertsRequest = null): \Upsun\Model\GetUsageAlerts200Response
```
...
|-----------------------------|--------------------------------------------|---------------------------------------|
| `$subscriptionId`           | **string**                                 | The ID of the subscription (required) |
| `$updateUsageAlertsRequest` | **?\Upsun\Model\UpdateUsageAlertsRequest** |                                       |
...
* https://docs.upsun.com/api/#tag/Alerts/operation/update-usage-alerts

***

### updateUsageAlertsWithHttpInfo

Update usage alerts. with HTTP Info

```php
private updateUsageAlertsWithHttpInfo(string $subscriptionId, ?\Upsun\Model\UpdateUsageAlertsRequest $updateUsageAlertsRequest = null): \Upsun\Model\GetUsageAlerts200Response
```
...
```php
private updateUsageAlertsRequest(string $subscriptionId, ?\Upsun\Model\UpdateUsageAlertsRequest $updateUsageAlertsRequest = null): \Psr\Http\Message\RequestInterface
```
