...
```php
public getOrgAddons(string $organizationId): \Upsun\Model\OrganizationAddonsObject
```
...
* https://docs.upsun.com/api/#tag/Add-ons/operation/get-org-addons

***

### getOrgAddonsWithHttpInfo

Get add-ons with HTTP Info

```php
private getOrgAddonsWithHttpInfo(string $organizationId): \Upsun\Model\OrganizationAddonsObject
```
...
```php
private getOrgAddonsRequest(string $organizationId): \Psr\Http\Message\RequestInterface
```
...
```php
public updateOrgAddons(string $organizationId, \Upsun\Model\UpdateOrgAddonsRequest $updateOrgAddonsRequest): \Upsun\Model\OrganizationAddonsObject
```
...
* https://docs.upsun.com/api/#tag/Add-ons/operation/update-org-addons

***

### updateOrgAddonsWithHttpInfo

Update organization add-ons with HTTP Info

```php
private updateOrgAddonsWithHttpInfo(string $organizationId, \Upsun\Model\UpdateOrgAddonsRequest $updateOrgAddonsRequest): \Upsun\Model\OrganizationAddonsObject
```
...
```php
private updateOrgAddonsRequest(string $organizationId, \Upsun\Model\UpdateOrgAddonsRequest $updateOrgAddonsRequest): \Psr\Http\Message\RequestInterface
```
