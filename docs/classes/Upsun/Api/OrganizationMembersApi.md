...
* Full name: `\Upsun\Api\OrganizationMembersApi`
...
```php
public createOrgMember(string $organizationId, \Upsun\Model\CreateOrgMemberRequest $createOrgMemberRequest): \Upsun\Model\OrganizationMember
```
...
| `$createOrgMemberRequest` | **\Upsun\Model\CreateOrgMemberRequest** |                                        |
...
* https://docs.upsun.com/api/#tag/Organization-Members/operation/create-org-member

***

### createOrgMemberWithHttpInfo

Create organization member with HTTP Info

```php
private createOrgMemberWithHttpInfo(string $organizationId, \Upsun\Model\CreateOrgMemberRequest $createOrgMemberRequest): \Upsun\Model\OrganizationMember
```
...
```php
private createOrgMemberRequest(string $organizationId, \Upsun\Model\CreateOrgMemberRequest $createOrgMemberRequest): \Psr\Http\Message\RequestInterface
```
...
```php
public deleteOrgMember(string $organizationId, string $userId): void
```
...
* https://docs.upsun.com/api/#tag/Organization-Members/operation/delete-org-member

***

### deleteOrgMemberWithHttpInfo

Delete organization member with HTTP Info

```php
private deleteOrgMemberWithHttpInfo(string $organizationId, string $userId): void
```
...
```php
private deleteOrgMemberRequest(string $organizationId, string $userId): \Psr\Http\Message\RequestInterface
```
...
```php
public getOrgMember(string $organizationId, string $userId): \Upsun\Model\OrganizationMember
```
...
* https://docs.upsun.com/api/#tag/Organization-Members/operation/get-org-member

***

### getOrgMemberWithHttpInfo

Get organization member with HTTP Info

```php
private getOrgMemberWithHttpInfo(string $organizationId, string $userId): \Upsun\Model\OrganizationMember
```
...
```php
private getOrgMemberRequest(string $organizationId, string $userId): \Psr\Http\Message\RequestInterface
```
...
```php
public listOrgMembers(string $organizationId, \Upsun\Model\ArrayFilter|null $filterPermissions = null, int|null $pageSize = null, string|null $pageBefore = null, string|null $pageAfter = null, string|null $sort = null): \Upsun\Model\ListOrgMembers200Response
```
...
* https://docs.upsun.com/api/#tag/Organization-Members/operation/list-org-members

***

### listOrgMembersWithHttpInfo

List organization members with HTTP Info

```php
private listOrgMembersWithHttpInfo(string $organizationId, \Upsun\Model\ArrayFilter|null $filterPermissions = null, int|null $pageSize = null, string|null $pageBefore = null, string|null $pageAfter = null, string|null $sort = null): \Upsun\Model\ListOrgMembers200Response
```
...
```php
private listOrgMembersRequest(string $organizationId, \Upsun\Model\ArrayFilter|null $filterPermissions = null, int|null $pageSize = null, string|null $pageBefore = null, string|null $pageAfter = null, string|null $sort = null): \Psr\Http\Message\RequestInterface
```
...
```php
public updateOrgMember(string $organizationId, string $userId, ?\Upsun\Model\UpdateOrgMemberRequest $updateOrgMemberRequest = null): \Upsun\Model\OrganizationMember
```
...
| `$organizationId`         | **string**                               | The ID of the organization. (required) |
| `$userId`                 | **string**                               | The ID of the user. (required)         |
| `$updateOrgMemberRequest` | **?\Upsun\Model\UpdateOrgMemberRequest** |                                        |
...
* https://docs.upsun.com/api/#tag/Organization-Members/operation/update-org-member

***

### updateOrgMemberWithHttpInfo

Update organization member with HTTP Info

```php
private updateOrgMemberWithHttpInfo(string $organizationId, string $userId, ?\Upsun\Model\UpdateOrgMemberRequest $updateOrgMemberRequest = null): \Upsun\Model\OrganizationMember
```
...
```php
private updateOrgMemberRequest(string $organizationId, string $userId, ?\Upsun\Model\UpdateOrgMemberRequest $updateOrgMemberRequest = null): \Psr\Http\Message\RequestInterface
```
