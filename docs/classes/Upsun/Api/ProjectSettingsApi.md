...
* Full name: `\Upsun\Api\ProjectSettingsApi`
...
```php
public getProjectsSettings(string $projectId): \Upsun\Model\ProjectSettings
```
...
* https://docs.upsun.com/api/#tag/Project-Settings/operation/get-projects-settings

***

### getProjectsSettingsWithHttpInfo

Get list of project settings with HTTP Info

```php
private getProjectsSettingsWithHttpInfo(string $projectId): \Upsun\Model\ProjectSettings
```
...
### getProjectsSettingsRequest

Create request for operation 'getProjectsSettings'

```php
private getProjectsSettingsRequest(string $projectId): \Psr\Http\Message\RequestInterface
```
...
```php
public updateProjectsSettings(string $projectId, \Upsun\Model\ProjectSettingsPatch $projectSettingsPatch): \Upsun\Model\AcceptedResponse
```
...
|-------------------------|---------------------------------------|-------------|
| `$projectId`            | **string**                            |             |
| `$projectSettingsPatch` | **\Upsun\Model\ProjectSettingsPatch** | (required)  |
...
* https://docs.upsun.com/api/#tag/Project-Settings/operation/update-projects-settings

***

### updateProjectsSettingsWithHttpInfo

Update a project setting with HTTP Info

```php
private updateProjectsSettingsWithHttpInfo(string $projectId, \Upsun\Model\ProjectSettingsPatch $projectSettingsPatch): \Upsun\Model\AcceptedResponse
```
...
### updateProjectsSettingsRequest

Create request for operation 'updateProjectsSettings'

```php
private updateProjectsSettingsRequest(string $projectId, \Upsun\Model\ProjectSettingsPatch $projectSettingsPatch): \Psr\Http\Message\RequestInterface
```
