...
```php
public \Upsun\Core\Tasks\IntegrationsTask $integrations
```
...
```php
public \Upsun\Core\Tasks\UsersInvitationsTask $invitations
```
...
```php
public \Upsun\Core\Tasks\RepositoriesTask $repositories
```
...
```php
public \Upsun\Core\Tasks\ServicesTask $services
```
...
```php
public \Upsun\Core\Tasks\SshTask $sshTask
```
