...
```php
public configGet(string $projectId, string $environmentId, string $applicationId): ?\Upsun\Model\WebApplicationsValue
```
...
```php
public list(string $projectId, string $environmentId): array<string,\Upsun\Model\WebApplicationsValue>
```
