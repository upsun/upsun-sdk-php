...
```php
public add(string $projectId, \Upsun\Model\DomainCreateInput $domainCreateInput, ?string $environmentId = null): \Upsun\Model\AcceptedResponse
```
...
|----------------------|------------------------------------|---------------------------------------------------------------------------|
| `$projectId`         | **string**                         |                                                                           |
| `$domainCreateInput` | **\Upsun\Model\DomainCreateInput** | is an instance of ProdDomainStoragePatch
...
```php
public update(string $projectId, string $domainId, \Upsun\Model\DomainPatch $domainPatch, ?string $environmentId = null): \Upsun\Model\AcceptedResponse
```
