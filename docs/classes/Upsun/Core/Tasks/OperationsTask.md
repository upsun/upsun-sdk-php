...
```php
private \Upsun\Api\RuntimeOperationsApi $runtimeOperationsApi
```
...
```php
public __construct(\Upsun\UpsunClient $client, \Upsun\Api\RuntimeOperationsApi $runtimeOperationsApi): mixed
```
...
| `$runtimeOperationsApi` | **\Upsun\Api\RuntimeOperationsApi** |             |
