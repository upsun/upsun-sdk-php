...
* Full name: `\Upsun\Model\SubscriptionInformation`
...
|-----------------------------|------------|------|------------------------|
| `PLAN__2XLARGE`             | public     |      | '2xlarge'              |
| `PLAN__2XLARGE_HIGH_MEMORY` | public     |      | '2xlarge-high-memory'  |
| `PLAN__4XLARGE`             | public     |      | '4xlarge'              |
| `PLAN__8XLARGE`             | public     |      | '8xlarge'              |
| `PLAN_DEVELOPMENT`          | public     |      | 'development'          |
| `PLAN_LARGE`                | public     |      | 'large'                |
| `PLAN_LARGE_HIGH_MEMORY`    | public     |      | 'large-high-memory'    |
| `PLAN_MEDIUM`               | public     |      | 'medium'               |
| `PLAN_MEDIUM_HIGH_MEMORY`   | public     |      | 'medium-high-memory'   |
| `PLAN_STANDARD`             | public     |      | 'standard'             |
| `PLAN_STANDARD_HIGH_MEMORY` | public     |      | 'standard-high-memory' |
| `PLAN_XLARGE`               | public     |      | 'xlarge'               |
| `PLAN_XLARGE_HIGH_MEMORY`   | public     |      | 'xlarge-high-memory'   |
