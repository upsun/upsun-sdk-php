...
|-------------------------|------------|------|------------------|
| `TYPE_INVOICE`          | public     |      | 'invoice'        |
| `TYPE_CREDIT_MEMO`      | public     |      | 'credit_memo'    |
| `STATUS_PAID`           | public     |      | 'paid'           |
| `STATUS_CHARGED_OFF`    | public     |      | 'charged_off'    |
| `STATUS_PENDING`        | public     |      | 'pending'        |
| `STATUS_REFUNDED`       | public     |      | 'refunded'       |
| `STATUS_CANCELED`       | public     |      | 'canceled'       |
| `STATUS_REFUND_PENDING` | public     |      | 'refund_pending' |
