...
* Full name: `\Upsun\Model\NewRelicIntegration`
...
```php
public __construct(string $type, array $extra, string $url, bool $tlsVerify, array $excludedServices, ?\DateTime $createdAt, ?\DateTime $updatedAt, ?string $id = null): mixed
```
