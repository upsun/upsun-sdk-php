...
| `STATUS_PAST_DUE`                    | public     |      | 'past_due'                    |
| `STATUS_PENDING`                     | public     |      | 'pending'                     |
| `STATUS_CANCELED`                    | public     |      | 'canceled'                    |
| `STATUS_PAYMENT_FAILED_SOFT_DECLINE` | public     |      | 'payment_failed_soft_decline' |
| `STATUS_PAYMENT_FAILED_HARD_DECLINE` | public     |      | 'payment_failed_hard_decline' |
