...
Low level ListProjectTeamAccess200Response (auto-generated)

***

* Full name: `\Upsun\Model\ListProjectTeamAccess200Response`
...
```php
public getItems(): \Upsun\Model\TeamProjectAccess[]|null
```
