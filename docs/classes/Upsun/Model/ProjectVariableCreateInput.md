...
* Full name: `\Upsun\Model\ProjectVariableCreateInput`
...
```php
public __construct(string $name, string $value, ?array $attributes = [], ?bool $isJson = null, ?bool $isSensitive = null, ?bool $visibleBuild = null, ?bool $visibleRuntime = null, ?array $applicationScope = []): mixed
```
