...
|---------------------------------------------------|------------|------|-----------------------------|
| `TYPE_PROBLEM`                                    | public     |      | 'problem'                   |
| `TYPE_TASK`                                       | public     |      | 'task'                      |
| `TYPE_INCIDENT`                                   | public     |      | 'incident'                  |
| `TYPE_QUESTION`                                   | public     |      | 'question'                  |
| `PRIORITY_LOW`                                    | public     |      | 'low'                       |
| `PRIORITY_NORMAL`                                 | public     |      | 'normal'                    |
| `PRIORITY_HIGH`                                   | public     |      | 'high'                      |
| `PRIORITY_URGENT`                                 | public     |      | 'urgent'                    |
| `STATUS_CLOSED`                                   | public     |      | 'closed'                    |
| `STATUS_DELETED`                                  | public     |      | 'deleted'                   |
| `STATUS_HOLD`                                     | public     |      | 'hold'                      |
| `STATUS__NEW`                                     | public     |      | 'new'                       |
| `STATUS_OPEN`                                     | public     |      | 'open'                      |
| `STATUS_PENDING`                                  | public     |      | 'pending'                   |
...
| `ENVIRONMENT_ENV_DEVELOPMENT`                     | public     |      | 'env_development'           |
| `ENVIRONMENT_ENV_STAGING`                         | public     |      | 'env_staging'               |
| `ENVIRONMENT_ENV_PRODUCTION`                      | public     |      | 'env_production'            |
| `TICKET_SHARING_STATUS_TS_SENT_TO_PLATFORM`       | public     |      | 'ts_sent_to_platform'       |
| `TICKET_SHARING_STATUS_TS_ACCEPTED_BY_PLATFORM`   | public     |      | 'ts_accepted_by_platform'   |
| `TICKET_SHARING_STATUS_TS_RETURNED_FROM_PLATFORM` | public     |      | 'ts_returned_from_platform' |
| `TICKET_SHARING_STATUS_TS_SOLVED_BY_PLATFORM`     | public     |      | 'ts_solved_by_platform'     |
| `TICKET_SHARING_STATUS_TS_REJECTED_BY_PLATFORM`   | public     |      | 'ts_rejected_by_platform'   |
