...
|----------------------------------------------|------------|------|-----------------|
| `DEVELOPMENT_SERVICE_SIZE__2_XL`             | public     |      | '2XL'           |
| `DEVELOPMENT_SERVICE_SIZE__4_XL`             | public     |      | '4XL'           |
| `DEVELOPMENT_SERVICE_SIZE_L`                 | public     |      | 'L'             |
| `DEVELOPMENT_SERVICE_SIZE_M`                 | public     |      | 'M'             |
| `DEVELOPMENT_SERVICE_SIZE_S`                 | public     |      | 'S'             |
| `DEVELOPMENT_SERVICE_SIZE_XL`                | public     |      | 'XL'            |
| `DEVELOPMENT_APPLICATION_SIZE__2_XL`         | public     |      | '2XL'           |
| `DEVELOPMENT_APPLICATION_SIZE__4_XL`         | public     |      | '4XL'           |
| `DEVELOPMENT_APPLICATION_SIZE_L`             | public     |      | 'L'             |
| `DEVELOPMENT_APPLICATION_SIZE_M`             | public     |      | 'M'             |
| `DEVELOPMENT_APPLICATION_SIZE_S`             | public     |      | 'S'             |
| `DEVELOPMENT_APPLICATION_SIZE_XL`            | public     |      | 'XL'            |
| `CERTIFICATE_STYLE_ECDSA`                    | public     |      | 'ecdsa'         |
| `CERTIFICATE_STYLE_RSA`                      | public     |      | 'rsa'           |
| `ENVIRONMENT_NAME_STRATEGY_HASH`             | public     |      | 'hash'          |
| `ENVIRONMENT_NAME_STRATEGY_NAME_AND_HASH`    | public     |      | 'name-and-hash' |
| `OUTBOUND_RESTRICTIONS_DEFAULT_POLICY_ALLOW` | public     |      | 'allow'         |
| `OUTBOUND_RESTRICTIONS_DEFAULT_POLICY_DENY`  | public     |      | 'deny'          |
