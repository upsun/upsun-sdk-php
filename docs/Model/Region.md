...
**selectionLabel** | **string** | The label to display when choosing between regions for new projects. | [optional]
**projectLabel** | **string** | The label to display on existing projects. | [optional]
...
**environmentalImpact** | [**\Upsun\Model\RegionEnvironmentalImpact**](RegionEnvironmentalImpact.md) |  | [optional]
