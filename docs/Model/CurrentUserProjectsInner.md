...
**clusterLabel** | **string** | The human-readable name of the region where the project is located. | [optional]
...
**regionLabel** | **string** | The human-readable name of the region where the project is located. | [optional]
...
**licenseId** | **int** | The ID of the subscription. | [optional]
...
**vendorLabel** | **string** | The machine name of the vendor the subscription belongs to. | [optional]
**vendorWebsite** | **string** | The URL of the vendor the subscription belongs to. | [optional]
**vendorResources** | **string** | The link to the resources of the vendor the subscription belongs to. | [optional]
**createdAt** | **\DateTime** | The creation date of the subscription. | [optional]
