...
**disk** | **int** | The writeable disk size to reserve on this application container. |
...
**worker** | [**\Upsun\Model\WorkerConfiguration**](WorkerConfiguration.md) |  |
**app** | **string** |  |
**stack** | **object[]** |  |
**instanceCount** | **int** | Instance replication count of this worker |
