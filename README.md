...
```php
$projects = $client->organization->listProjects('<organizationId>');
```

### Example: Get a project

```php
$project = $client->project->get('<projectId>');
```
...
$response = $client->project->update(<projectId>, $projectData);
```
...
*DeploymentApi* | [**updateProjectsEnvironmentsDeploymentsNext**](docs/Api/DeploymentApi.md#updateprojectsenvironmentsdeploymentsnext) | **PATCH** /projects/{projectId}/environments/{environmentId}/deployments/next | Update the next deployment
...
- [GetOrgPrepaymentInfo200ResponsePrepayment](docs/Model/GetOrgPrepaymentInfo200ResponsePrepayment.md)
...
- [ListOrgPrepaymentTransactions200ResponseLinksAllOfPrepayment](docs/Model/ListOrgPrepaymentTransactions200ResponseLinksAllOfPrepayment.md)
...
- [ServerSideIncludeConfiguration1](docs/Model/ServerSideIncludeConfiguration1.md)
