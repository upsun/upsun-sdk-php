...
/**
 * OrganizationEstimationObjectSubscriptionsListInnerUsage Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationEstimationObjectSubscriptionsListInnerUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationEstimationObject_subscriptions_list_inner_usage';
    ...
    */
     ...
     * Sets cpu
     *
     * @param float|null $cpu The total cpu for this subsciption.
     *
     * @return self
     */
     ...
     * Sets memory
     *
     * @param float|null $memory The total memory for this subsciption.
     *
     * @return self
     */
     ...
     * Sets storage
     *
     * @param float|null $storage The total storage for this subsciption.
     *
     * @return self
     */
     ...
     * Sets environments
     *
     * @param int|null $environments The total environments for this subsciption.
     *
     * @return self
     */
