...
class CreateTeamRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_team_request';
    ...
    */
     ...
     *
     * @param string $organization_id The ID of the parent organization.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The human-readable label of the team.
     *
     * @return self
     */
