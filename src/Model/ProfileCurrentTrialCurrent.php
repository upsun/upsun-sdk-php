...
final class ProfileCurrentTrialCurrent implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    private static string $openAPIModelName = 'Profile_current_trial_current';
