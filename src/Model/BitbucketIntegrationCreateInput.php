...
/**
 * BitbucketIntegrationCreateInput Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class BitbucketIntegrationCreateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BitbucketIntegrationCreateInput';
    ...
    */
     ...
     *
     * @param \Upsun\Model\TheOAuth2ConsumerInformationOptional1|null $app_credentials app_credentials
     *
     * @return self
     */
     ...
     *
     * @param \Upsun\Model\TheAddonCredentialInformationOptional1|null $addon_credentials addon_credentials
     *
     * @return self
     */
