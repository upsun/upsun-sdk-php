...
/**
 * CacheConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class CacheConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cache_configuration_';
    ...
    */
     ...
     * Sets default_ttl
     *
     * @param int $default_ttl default_ttl
     *
     * @return self
     */
