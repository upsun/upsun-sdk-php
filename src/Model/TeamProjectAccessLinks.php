...
class TeamProjectAccessLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets self
     *
     * @param \Upsun\Model\TeamProjectAccessLinksSelf|null $self self
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \Upsun\Model\TeamProjectAccessLinksUpdate|null $update update
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param \Upsun\Model\TeamProjectAccessLinksDelete|null $delete delete
     *
     * @return self
     */
