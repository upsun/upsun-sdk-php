...
class TheSpecificationOfTheWebLocationsServedByThisApplicationValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets rules
     *
     * @param array<string,\Upsun\Model\SpecificOverridesValue> $rules rules
     *
     * @return self
     */
     ...
     *
     * @param \Upsun\Model\ConfigurationForSupportingRequestBuffering|null $request_buffering request_buffering
     *
     * @return self
     */
