...
final class OrganizationLinksEstimateSubscription implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    private static string $openAPIModelName = 'Organization__links_estimate_subscription';
