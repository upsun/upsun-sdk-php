...
/**
 * EstimationObject Class Doc Comment
 *
 * @category Class
 ...
 */
class EstimationObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EstimationObject';
    ...
    */
     ...
     * Sets plan
     *
     * @param string|null $plan The monthly price of the plan.
     *
     * @return self
     */
     ...
     * Sets user_licenses
     *
     * @param string|null $user_licenses The monthly price of the user licenses.
     *
     * @return self
     */
     ...
     * Sets environments
     *
     * @param string|null $environments The monthly price of the environments.
     *
     * @return self
     */
     ...
     * Sets storage
     *
     * @param string|null $storage The monthly price of the storage.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param string|null $total The total monthly price.
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object|null $options The unit prices of the options.
     *
     * @return self
     */
