...
final class OrganizationLinksProfile implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    private static string $openAPIModelName = 'Organization__links_profile';
