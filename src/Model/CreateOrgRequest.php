...
class CreateOrgRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_org_request';
    ...
    */
     ...
     * Sets owner_id
     *
     * @param string|null $owner_id ID of the owner.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The human-readable label of the organization.
     *
     * @return self
     */
