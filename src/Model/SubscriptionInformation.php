...
/**
 * SubscriptionInformation Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_information';
    ...
    */
     ...
     * Sets resources
     *
     * @param \Upsun\Model\ResourcesLimits|null $resources resources
     *
     * @return self
     */
     ...
     * Sets image_types
     *
     * @param \Upsun\Model\RestrictedAndDeniedImageTypes|null $image_types image_types
     *
     * @return self
     */
