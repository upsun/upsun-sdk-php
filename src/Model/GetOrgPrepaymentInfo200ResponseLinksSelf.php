...
final class GetOrgPrepaymentInfo200ResponseLinksSelf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;
    /**
     * The original name of the model.
     */
    private static string $openAPIModelName = 'get_org_prepayment_info_200_response__links_self';
