...
/**
 * SubscriptionAddonsObjectUpgradesAvailable Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionAddonsObjectUpgradesAvailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionAddonsObject_upgrades_available';
    ...
    */
     ...
     *
     * @param string[]|null $continuous_profiling Available upgrade options for continuous profiling.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $project_support_level Available upgrade options for project uptime.
     *
     * @return self
     */
