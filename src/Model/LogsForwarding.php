...
/**
 * LogsForwarding Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class LogsForwarding implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Logs_Forwarding';
    ...
    {
        $this->setIfExists('max_extra_payload_size', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_extra_payload_size'] === null) {
            $invalidProperties[] = "'max_extra_payload_size' can't be null";
        }
     ...
     *
     * @param int $max_extra_payload_size max_extra_payload_size
     *
     * @return self
     */
    public function setMaxExtraPayloadSize($max_extra_payload_size)
    {
        ...
        $this->container['max_extra_payload_size'] = $max_extra_payload_size;
