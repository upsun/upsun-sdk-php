...
class OrganizationMemberLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets self
     *
     * @param \Upsun\Model\OrganizationMemberLinksSelf|null $self self
     *
     * @return self
     */
     ...
     * Sets update
     *
     * @param \Upsun\Model\OrganizationMemberLinksUpdate|null $update update
     *
     * @return self
     */
     ...
     * Sets delete
     *
     * @param \Upsun\Model\OrganizationMemberLinksDelete|null $delete delete
     *
     * @return self
     */
