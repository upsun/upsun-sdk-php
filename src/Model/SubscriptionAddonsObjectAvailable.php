...
class SubscriptionAddonsObjectAvailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,float>|null $continuous_profiling Information about the continuous profiling options available.
     *
     * @return self
     */
     ...
     *
     * @param array<string,float>|null $project_support_level Information about the project uptime options available.
     *
     * @return self
     */
