...
final class GetTypeAllowance200ResponseCurrenciesEUR implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    private static string $openAPIModelName = 'get_type_allowance_200_response_currencies_EUR';
