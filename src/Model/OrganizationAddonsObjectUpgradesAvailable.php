...
/**
 * OrganizationAddonsObjectUpgradesAvailable Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationAddonsObjectUpgradesAvailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationAddonsObject_upgrades_available';
    ...
    */
     ...
     *
     * @param string[]|null $user_management Available upgrade options for user management.
     *
     * @return self
     */
     ...
     * Sets support_level
     *
     * @param string[]|null $support_level Available upgrade options for support.
     *
     * @return self
     */
