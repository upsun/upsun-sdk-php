...
/**
 * EnvironmentInfo Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class EnvironmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Environment_Info';
    ...
    */
     ...
     * Sets is_production
     *
     * @param bool $is_production is_production
     *
     * @return self
     */
