...
/**
 * FoundationDeploymentTarget Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class FoundationDeploymentTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FoundationDeploymentTarget';
    ...
    */
     ...
     * Sets hosts
     *
     * @param \Upsun\Model\TheHostsOfTheDeploymentTargetInner[] $hosts hosts
     *
     * @return self
     */
