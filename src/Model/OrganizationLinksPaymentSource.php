...
final class OrganizationLinksPaymentSource implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    private static string $openAPIModelName = 'Organization__links_payment_source';
