...
class ConfigurationForAccessingThisApplicationViaHTTP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets locations
     *
     * @param array<string,\Upsun\Model\TheSpecificationOfTheWebLocationsServedByThisApplicationValue> $locations locations
     *
     * @return self
     */
     ...
     * Sets commands
     *
     * @param \Upsun\Model\CommandsToManageTheApplicationSLifecycle|null $commands commands
     *
     * @return self
     */
     ...
     * Sets upstream
     *
     * @param \Upsun\Model\ConfigurationOnHowTheWebServerCommunicatesWithTheApplication|null $upstream upstream
     *
     * @return self
     */
