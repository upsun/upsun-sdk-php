...
/**
 * EnterpriseDeploymentTarget Class Doc Comment
 *
 * @category Class
 * @package  Upsun
 * @author   OpenAPI Generator team
 ...
 */
class EnterpriseDeploymentTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnterpriseDeploymentTarget';
    ...
    */
     ...
     * Sets docroots
     *
     * @param array<string,\Upsun\Model\MappingOfClustersToEnterpriseApplicationsValue> $docroots docroots
     *
     * @return self
     */
