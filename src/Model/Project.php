...
class Project implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets status
     *
     * @param \Upsun\Model\Status $status status
     *
     * @return self
     */
     ...
     * Sets repository
     *
     * @param \Upsun\Model\RepositoryInformation $repository repository
     *
     * @return self
     */
     ...
     * Sets subscription
     *
     * @param \Upsun\Model\SubscriptionInformation $subscription subscription
     *
     * @return self
     */
