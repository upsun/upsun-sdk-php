...
class SSHKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets key_id
     *
     * @param int|null $key_id The ID of the public key.
     *
     * @return self
     */
     ...
     * Sets uid
     *
     * @param int|null $uid The internal user ID.
     *
     * @return self
     */
     ...
     * Sets fingerprint
     *
     * @param string|null $fingerprint The fingerprint of the public key.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The title of the public key.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The actual value of the public key.
     *
     * @return self
     */
     ...
     * Sets changed
     *
     * @param string|null $changed The time of the last key modification (ISO 8601)
     *
     * @return self
     */
