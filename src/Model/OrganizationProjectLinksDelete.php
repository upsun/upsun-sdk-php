...
final class OrganizationProjectLinksDelete implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     */
    private static string $openAPIModelName = 'OrganizationProject__links_delete';
