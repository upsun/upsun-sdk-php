...
final class SshKeysApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Ssh-Keys/operation/create-ssh-key
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Ssh-Keys/operation/delete-ssh-key
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Ssh-Keys/operation/get-ssh-key
     */
