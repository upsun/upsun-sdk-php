...
final class EnvironmentTypeApi extends AbstractApi
{
     ...
     * @see
     * curl -X GET "https://api.platform.sh/projects/{projectId}/environment-types/{environmentTypeId}" \
     ...
     * @see
     * curl -X GET "https://api.platform.sh/projects/{projectId}/environment-types" \
     *      -H "Authorization: Bearer ACCESS_TOKEN" \
     *      -H "Accept: application/json"
     */
