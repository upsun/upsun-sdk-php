...
final class AutoscalingApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Autoscaling/operation/get-autoscaler-settings
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Autoscaling/operation/patch-autoscaler-settings
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Autoscaling/operation/post-autoscaler-settings
     */
