...
final class PhoneNumberApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/PhoneNumber/operation/confirm-phone-number
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/PhoneNumber/operation/verify-phone-number
     */
