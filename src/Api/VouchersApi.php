...
class VouchersApi
{
     ...
     * @param  \Upsun\Model\ApplyOrgVoucherRequest $apply_org_voucher_request apply_org_voucher_request (required)
     *
     ...
     *
     * @param  string $organization_id The ID of the organization. (required)
     * @param  \Upsun\Model\ApplyOrgVoucherRequest $apply_org_voucher_request (required)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upsun\Model\Vouchers|\Upsun\Model\Error|\Upsun\Model\Error
     */
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\Vouchers|\Upsun\Model\Error|\Upsun\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
