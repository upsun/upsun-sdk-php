...
class ProjectActivityApi
{
     ...
     */
    public function actionProjectsActivitiesCancelWithHttpInfo($project_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function actionProjectsActivitiesCancelAsync($project_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function actionProjectsActivitiesCancelAsyncWithHttpInfo($project_id, $activity_id)
    {
     ...
     */
    public function actionProjectsActivitiesCancelRequest($project_id, $activity_id)
    {
     ...
     */
    public function getProjectsActivitiesWithHttpInfo($project_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsActivitiesAsync($project_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsActivitiesAsyncWithHttpInfo($project_id, $activity_id)
    {
     ...
     * @return RequestInterface
     */
    public function getProjectsActivitiesRequest($project_id, $activity_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return array of \Upsun\Model\Activity[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listProjectsActivitiesWithHttpInfo($project_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsActivitiesAsync($project_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsActivitiesAsyncWithHttpInfo($project_id)
    {
        $returnType = '\Upsun\Model\Activity[]';
        $request = $this->listProjectsActivitiesRequest($project_id);
     ...
     * @return RequestInterface
     */
    public function listProjectsActivitiesRequest($project_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
