...
final class ProjectInvitationsApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Project-Invitations/operation/cancel-project-invite
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Project-Invitations/operation/create-project-invite
     */
    ...
    */
     ...
     * @see https://developer.upsun.com/api/#tag/Project-Invitations/operation/list-project-invites
     */
