...
class AddOnsApi
{
     ...
     * @return \Upsun\Model\OrganizationAddonsObject|\Upsun\Model\Error|\Upsun\Model\Error
     */
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\OrganizationAddonsObject|\Upsun\Model\Error|\Upsun\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrgAddonsWithHttpInfo($organization_id)
    {
     ...
     * @return Promise
     */
    public function getOrgAddonsAsync($organization_id)
    {
     ...
     * @return Promise
     */
    public function getOrgAddonsAsyncWithHttpInfo($organization_id)
    {
     ...
     */
    public function getOrgAddonsRequest($organization_id)
    {
