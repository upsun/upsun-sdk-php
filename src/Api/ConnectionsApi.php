...
final class ConnectionsApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Connections/operation/delete-login-connection
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Connections/operation/get-login-connection
     */
    ...
    */
     ...
     * @see https://developer.upsun.com/api/#tag/Connections/operation/list-login-connections
     */
