...
final class ProjectSettingsApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Project-Settings/operation/get-projects-settings
     */
    ...
    */
     ...
     *
     * @param  \Upsun\Model\ProjectSettingsPatch $projectSettingsPatch (required)
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Project-Settings/operation/update-projects-settings
     */
