...
class ProjectSettingsApi
{
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\ProjectSettings, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $project_id project_id (required)
     * @param  \Upsun\Model\ProjectSettingsPatch $project_settings_patch  (required)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
