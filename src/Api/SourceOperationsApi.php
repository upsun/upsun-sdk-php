...
class SourceOperationsApi
{
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\EnvironmentSourceOperation[], HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $project_id project_id (required)
     * @param  string $environment_id environment_id (required)
     * @param  \Upsun\Model\EnvironmentSourceOperationInput $environment_source_operation_input  (required)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
