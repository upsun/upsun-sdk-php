...
final class ApiTokensApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Api-Tokens/operation/create-api-token
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Api-Tokens/operation/delete-api-token
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Api-Tokens/operation/get-api-token
     */
    ...
    */
     ...
     * @see https://developer.upsun.com/api/#tag/Api-Tokens/operation/list-api-tokens
     */
