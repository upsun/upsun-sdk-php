...
final class ProjectApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Project/operation/action-projects-clear-build-cache
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Project/operation/get-projects
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Project/operation/get-projects-capabilities
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Project/operation/maintenance-redeploy-project
     */
