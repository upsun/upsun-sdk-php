...
class CertManagementApi
{
     ...
     * @param  \Upsun\Model\CertificateCreateInput $certificate_create_input  (required)
     *
     ...
     */
    public function createProjectsCertificatesWithHttpInfo($project_id, $certificate_create_input)
    {
     ...
     * @return Promise
     */
    public function createProjectsCertificatesAsync($project_id, $certificate_create_input)
    {
     ...
     * @return Promise
     */
    public function createProjectsCertificatesAsyncWithHttpInfo($project_id, $certificate_create_input)
    {
     ...
     * @return array of \Upsun\Model\AcceptedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteProjectsCertificatesWithHttpInfo($project_id, $certificate_id)
    {
     ...
     * @return Promise
     */
    public function deleteProjectsCertificatesAsync($project_id, $certificate_id)
    {
     ...
     * @return Promise
     */
    public function deleteProjectsCertificatesAsyncWithHttpInfo($project_id, $certificate_id)
    {
        $returnType = '\Upsun\Model\AcceptedResponse';
        $request = $this->deleteProjectsCertificatesRequest($project_id, $certificate_id);
     ...
     * @return RequestInterface
     */
    public function deleteProjectsCertificatesRequest($project_id, $certificate_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\Certificate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProjectsCertificatesWithHttpInfo($project_id, $certificate_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsCertificatesAsync($project_id, $certificate_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsCertificatesAsyncWithHttpInfo($project_id, $certificate_id)
    {
     ...
     * @return RequestInterface
     */
    public function getProjectsCertificatesRequest($project_id, $certificate_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return array of \Upsun\Model\Certificate[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listProjectsCertificatesWithHttpInfo($project_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsCertificatesAsync($project_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsCertificatesAsyncWithHttpInfo($project_id)
    {
        $returnType = '\Upsun\Model\Certificate[]';
        $request = $this->listProjectsCertificatesRequest($project_id);
     ...
     * @return RequestInterface
     */
    public function listProjectsCertificatesRequest($project_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  string $project_id project_id (required)
     * @param  string $certificate_id certificate_id (required)
     * @param  \Upsun\Model\CertificatePatch $certificate_patch  (required)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upsun\Model\AcceptedResponse
     ...
     * @return array of \Upsun\Model\AcceptedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProjectsCertificatesWithHttpInfo($project_id, $certificate_id, $certificate_patch)
    {
     ...
     * @return Promise
     */
    public function updateProjectsCertificatesAsync($project_id, $certificate_id, $certificate_patch)
    {
     ...
     * @return Promise
     */
    public function updateProjectsCertificatesAsyncWithHttpInfo($project_id, $certificate_id, $certificate_patch)
    {
        $returnType = '\Upsun\Model\AcceptedResponse';
        $request = $this->updateProjectsCertificatesRequest($project_id, $certificate_id, $certificate_patch);
     ...
     * @return RequestInterface
     */
    public function updateProjectsCertificatesRequest($project_id, $certificate_id, $certificate_patch)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
