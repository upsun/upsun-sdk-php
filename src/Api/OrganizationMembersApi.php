...
final class OrganizationMembersApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Organization-Members/operation/create-org-member
     */
    ...
    */
    ...
    private function createOrgMemberRequest(
        ...
        if (empty($createOrgMemberRequest)) {
            throw new InvalidArgumentException(
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Members/operation/delete-org-member
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Members/operation/get-org-member
     */
    ...
    */
     ...
     *         The ID of the organization. Prefix with name= to retrieve the organization by
     *         name instead. (required)
     * @param  \Upsun\Model\ArrayFilter|null $filterPermissions (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Members/operation/list-org-members
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Members/operation/update-org-member
     */
