...
final class DeploymentApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Deployment/operation/get-projects-environments-deployments
     */
    ...
    */
     ...
     * @see https://developer.upsun.com/api/#tag/Deployment/operation/list-projects-environments-deployments
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Deployment/operation/update-projects-environments-deployments-next
     */
    ...
    */
    ...
    private function updateProjectsEnvironmentsDeploymentsNextRequest(
        ...
        if (empty($updateProjectsEnvironmentsDeploymentsNextRequest)) {
            throw new InvalidArgumentException(
