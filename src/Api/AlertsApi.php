...
class AlertsApi
{
     ...
     * @param  \Upsun\Model\CreateUsageAlertRequest $create_usage_alert_request create_usage_alert_request (optional)
     *
     ...
     *
     * @param  string $subscription_id The ID of the subscription (required)
     * @param  \Upsun\Model\CreateUsageAlertRequest $create_usage_alert_request (optional)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\Alert, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\GetUsageAlerts200Response, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $subscription_id The ID of the subscription (required)
     * @param  string $usage_id The usage id of the alert. (required)
     * @param  \Upsun\Model\UpdateUsageAlertRequest $update_usage_alert_request update_usage_alert_request (optional)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upsun\Model\Alert
     ...
     * @param  string $subscription_id The ID of the subscription (required)
     * @param  string $usage_id The usage id of the alert. (required)
     * @param  \Upsun\Model\UpdateUsageAlertRequest $update_usage_alert_request (optional)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\Alert, HTTP status code, HTTP response headers (array of strings)
