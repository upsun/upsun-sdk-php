...
class DeploymentTargetApi
{
     ...
     * @param  \Upsun\Model\DeploymentTargetCreateInput $deployment_target_create_input  (required)
     *
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\DeploymentTarget, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $project_id project_id (required)
     * @param  string $deployment_target_configuration_id deployment_target_configuration_id (required)
     * @param  \Upsun\Model\DeploymentTargetPatch $deployment_target_patch  (required)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upsun\Model\AcceptedResponse
