...
class RoutingApi
{
     ...
     * @param  \Upsun\Model\RouteCreateInput $route_create_input  (required)
     *
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\Route, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $environment_id environment_id (required)
     * @param  string $route_id route_id (required)
     * @param  \Upsun\Model\RoutePatch $route_patch  (required)
     *
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Upsun\Model\AcceptedResponse
