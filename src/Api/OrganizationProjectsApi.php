...
final class OrganizationProjectsApi extends AbstractApi
{
     ...
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/create-org-project
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/delete-org-project
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/get-org-project
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/list-org-projects
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/query-project-carbon
     */
    ...
    * @return Generator<int,\Upsun\Model\ProvisionEvent>
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/stream-org-project-provisioning
     */
    ...
    */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws ClientExceptionInterface
     * @see https://developer.upsun.com/api/#tag/Organization-Projects/operation/update-org-project
     */
