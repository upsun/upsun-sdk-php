...
class EnvironmentActivityApi
{
     ...
     */
    public function actionProjectsEnvironmentsActivitiesCancelWithHttpInfo($project_id, $environment_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function actionProjectsEnvironmentsActivitiesCancelAsync($project_id, $environment_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function actionProjectsEnvironmentsActivitiesCancelAsyncWithHttpInfo($project_id, $environment_id, $activity_id)
    {
     ...
     */
    public function actionProjectsEnvironmentsActivitiesCancelRequest($project_id, $environment_id, $activity_id)
    {
     ...
     * @throws \Upsun\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Upsun\Model\Activity, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProjectsEnvironmentsActivitiesWithHttpInfo($project_id, $environment_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsEnvironmentsActivitiesAsync($project_id, $environment_id, $activity_id)
    {
     ...
     * @return Promise
     */
    public function getProjectsEnvironmentsActivitiesAsyncWithHttpInfo($project_id, $environment_id, $activity_id)
    {
     ...
     * @return RequestInterface
     */
    public function getProjectsEnvironmentsActivitiesRequest($project_id, $environment_id, $activity_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return array of \Upsun\Model\Activity[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listProjectsEnvironmentsActivitiesWithHttpInfo($project_id, $environment_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsEnvironmentsActivitiesAsync($project_id, $environment_id)
    {
     ...
     * @return Promise
     */
    public function listProjectsEnvironmentsActivitiesAsyncWithHttpInfo($project_id, $environment_id)
    {
        $returnType = '\Upsun\Model\Activity[]';
        $request = $this->listProjectsEnvironmentsActivitiesRequest($project_id, $environment_id);
     ...
     * @return RequestInterface
     */
    public function listProjectsEnvironmentsActivitiesRequest($project_id, $environment_id)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
